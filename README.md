...
[Please find a different kind of layout here](https://github.com/akullpp/awesome-java/tree/test) ⭐ 47,009 | 🐛 3 | 📅 2026-02-07.

We are evaluating to make this the default, you can provide feedback here in [#1171](https://github.com/akullpp/awesome-java/issues/1171) ⭐ 47,009 | 🐛 3 | 📅 2026-02-07.
...
* [ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,599 | 🐛 180 | 🌐 Java | 📅 2026-02-11 - Test library for specifying and asserting architecture rules.
...
* [LangChain4j](https://github.com/langchain4j/langchain4j) ⭐ 10,740 | 🐛 653 | 🌐 Java | 📅 2026-02-12 - Simplifies integration of LLMs with unified APIs and a comprehensive toolbox.
* [MCP Java SDK](https://github.com/modelcontextprotocol/java-sdk) ⭐ 3,172 | 🐛 313 | 🌐 Java | 📅 2026-02-12 - Enables applications to interact with AI models and tools through a standardized interface (i.e. Model Context Protocol), supporting both synchronous and asynchronous communication patterns.
...
* [MapStruct](https://github.com/mapstruct/mapstruct) ⭐ 7,618 | 🐛 496 | 🌐 Java | 📅 2026-02-02 - Code generator that simplifies mappings between different bean types, based on a convention-over-configuration approach.
...
* [Buck2](https://github.com/facebook/buck2) ⭐ 4,252 | 🐛 345 | 🌐 Rust | 📅 2026-02-13 - Encourages the creation of small, reusable modules consisting of code and resources.
...
* [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,420 | 🐛 100 | 🌐 Java | 📅 2026-01-07 - Java 8 Jar & Android APK reverse engineering suite. (GPL-3.0-only)
* [cglib](https://github.com/cglib/cglib) ⭐ 4,890 | 🐛 96 | 🌐 Java | 📅 2024-08-16 - Bytecode generation library.
* [Javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,231 | 🐛 251 | 🌐 Java | 📅 2024-10-03 - Tries to simplify bytecode editing.
...
* [Caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,464 | 🐛 1 | 🌐 Java | 📅 2026-02-13 - High-performance, near-optimal caching library.
...
* [JLine](https://github.com/jline/jline3) ⭐ 1,715 | 🐛 74 | 🌐 Java | 📅 2026-02-12 - Includes features from modern shells like completion or history.
...
* [Google Cloud Client Libraries](https://github.com/googleapis/google-cloud-java) ⭐ 2,013 | 🐛 139 | 🌐 Java | 📅 2026-02-13 - Client libraries for accessing Google Cloud services from Java applications.

### Code Analysis

*Tools that provide metrics and quality measurements.*

* [p3c](https://github.com/alibaba/p3c) ⭐ 30,829 | 🐛 186 | 🌐 Kotlin | 📅 2024-08-06 - Provides Alibaba's coding guidelines for PMD, IDEA and Eclipse.
* [Infer](https://github.com/facebook/infer) ⭐ 15,517 | 🐛 406 | 🌐 OCaml | 📅 2026-02-12 - Modern static analysis tool for verifying the correctness of code.
* [Checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 8,856 | 🐛 932 | 🌐 Java | 📅 2026-02-12 - Static analysis of coding conventions and standards. (LGPL-2.1-or-later)
* [Error Prone](https://github.com/google/error-prone) ⭐ 7,135 | 🐛 465 | 🌐 Java | 📅 2026-02-12 - Catches common programming mistakes as compile-time errors.
* [PMD](https://github.com/pmd/pmd) ⭐ 5,318 | 🐛 623 | 🌐 Java | 📅 2026-02-11 - Source code analysis for finding bad coding practices.
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,007 | 🐛 132 | 🌐 Java | 📅 2026-02-13 - Eliminates NullPointerExceptions with low build-time overhead.
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,822 | 🐛 456 | 🌐 Java | 📅 2026-02-12 - Static analysis of bytecode to find potential bugs. (LGPL-2.1-only)
* [Spoon](https://github.com/INRIA/spoon) ⭐ 1,901 | 🐛 357 | 🌐 Java | 📅 2026-02-12 - Library for analyzing and transforming Java source code.
* [SonarJava](https://github.com/SonarSource/sonar-java) ⭐ 1,192 | 🐛 11 | 🌐 Java | 📅 2026-02-12 - Static analyzer for SonarQube & SonarLint. (LGPL-3.0-only)
...
* [JHipster](https://github.com/jhipster/generator-jhipster) ⭐ 22,344 | 🐛 140 | 🌐 TypeScript | 📅 2026-02-13 - Yeoman source code generator for Spring Boot and AngularJS.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - API to generate source files.
* [Auto](https://github.com/google/auto) ⭐ 10,553 | 🐛 87 | 🌐 Java | 📅 2026-02-10 - Generates factory, service, and value classes.
...
* [EasyEntityToDTO](https://github.com/Marcel091004/EasyEntityToDTO) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2026-02-12 - Annotation processor for automatic DTO and Mapper generation with zero boilerplate.
...
* [JavaCV](https://github.com/bytedeco/javacv) ⭐ 8,287 | 🐛 467 | 🌐 Java | 📅 2026-02-09 - Java interface to OpenCV, FFmpeg, and much more.

### Configuration

*Libraries that provide external configuration.*

* [config](https://github.com/lightbend/config) ⭐ 6,291 | 🐛 239 | 🌐 Java | 📅 2026-01-15 - Configuration library supporting Java properties, JSON or its human optimized superset HOCON.
...
* [FastCSV](https://github.com/osiegmar/FastCSV) ⭐ 662 | 🐛 5 | 🌐 Java | 📅 2026-02-02 - Performance-optimized, dependency-free and RFC 4180 compliant.
...
* [Protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,678 | 🐛 236 | 🌐 C++ | 📅 2026-02-13 - Google's data interchange format.
* [Wire](https://github.com/square/wire) ⭐ 4,405 | 🐛 168 | 🌐 Kotlin | 📅 2026-02-11 - Clean, lightweight protocol buffers.
* [RoaringBitmap](https://github.com/RoaringBitmap/RoaringBitmap) ⭐ 3,818 | 🐛 75 | 🌐 Java | 📅 2026-01-23 - Fast and efficient compressed bitmap.
* [SBE](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,391 | 🐛 37 | 🌐 Java | 📅 2026-01-30 - Simple Binary Encoding, one of the fastest message formats around.
* [Tape](https://github.com/square/tape) ⚠️ Archived - Lightning-fast, transactional, file-based FIFO.
* [Persistent Collection](https://github.com/hrldcpr/pcollections) ⭐ 783 | 🐛 21 | 🌐 Java | 📅 2025-07-23 - Persistent and immutable analogue of the Java Collections Framework.
...
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,012 | 🐛 526 | 🌐 Java | 📅 2025-11-04 - High-performance JDBC connection pool.
* [Apache ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,676 | 🐛 351 | 🌐 Java | 📅 2026-02-12 - Distributed SQL transaction & query engine that allows for data sharding, scaling, encryption, and more on any database.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,673 | 🐛 806 | 🌐 Java | 📅 2026-02-13 - High-performance SQL database for time series. Supports InfluxDB line protocol, PostgreSQL wire protocol, and REST.
* [Jedis](https://github.com/xetorthio/jedis) ⭐ 12,279 | 🐛 99 | 🌐 Java | 📅 2026-02-12 - Small client for interaction with Redis, with methods for commands.
* [Realm](https://github.com/realm/realm-java) ⭐ 11,492 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - Mobile database to run directly inside phones, tablets or wearables.
* [Leaf](https://github.com/Meituan-Dianping/Leaf) ⭐ 6,731 | 🐛 95 | 🌐 Java | 📅 2023-07-18 - Distributed ID generate service.
...
* [CosId](https://github.com/Ahoo-Wang/CosId) ⭐ 606 | 🐛 11 | 🌐 Java | 📅 2026-02-13 - Universal, flexible, high-performance distributed ID generator.
* [eXist](https://github.com/eXist-db/exist) ⭐ 460 | 🐛 564 | 🌐 Java | 📅 2026-02-11 - NoSQL document database and application platform. (LGPL-2.1-only)
...
* [Guice](https://github.com/google/guice) ⭐ 12,728 | 🐛 359 | 🌐 Java | 📅 2026-02-03 - Lightweight and opinionated framework that completes Dagger.
...
* [Manifold](https://github.com/manifold-systems/manifold) ⭐ 2,707 | 🐛 109 | 🌐 Java | 📅 2026-02-11 - Re-energizes Java with powerful features like type-safe metaprogramming, structural typing and extension methods.
...
* [Zuul](https://github.com/Netflix/zuul) ⭐ 13,981 | 🐛 9 | 🌐 Java | 📅 2026-02-12 - Gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
* [resilience4j](https://github.com/resilience4j/resilience4j) ⭐ 10,545 | 🐛 277 | 🌐 Java | 📅 2026-02-06 - Functional fault tolerance library.
* [Hazelcast](https://github.com/hazelcast/hazelcast) ⭐ 6,588 | 🐛 1,101 | 🌐 Java | 📅 2026-02-12 - Highly scalable in-memory datagrid with a free open-source version.
...
* [OpenIG](https://github.com/OpenIdentityPlatform/OpenIG) ⭐ 87 | 🐛 0 | 🌐 Java | 📅 2026-02-09 - High-performance reverse proxy server with specialized session management and credential replay functionality.
...
* [Seata](https://github.com/seata/seata) ⭐ 25,947 | 🐛 867 | 🌐 Java | 📅 2026-02-10 - Delivers high performance and easy to use distributed transaction services under a microservices architecture.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,376 | 🐛 22 | 🌐 Java | 📅 2026-02-12 - Library for technical analysis.
* [Stripe](https://github.com/stripe/stripe-java) ⭐ 950 | 🐛 26 | 🌐 Java | 📅 2026-02-12 - Integration with the Stripe API.
* [Cassandre](https://github.com/cassandre-tech/cassandre-trading-bot) ⭐ 651 | 🐛 17 | 🌐 Java | 📅 2025-03-01 - Trading bot framework.
...
* [GraphHopper](https://github.com/graphhopper/graphhopper) ⭐ 6,265 | 🐛 254 | 🌐 Java | 📅 2026-02-12 - Road-routing engine. Used as a Java library or standalone web service.
* [Mapsforge](https://github.com/mapsforge/mapsforge) ⭐ 1,338 | 🐛 2 | 🌐 Java | 📅 2026-02-09 - Map rendering based on OpenStreetMap data. (LGPL-3.0-only)
...
* [SnapKit](https://github.com/reportmill/SnapKit) ⭐ 312 | 🐛 1 | 🌐 Java | 📅 2026-02-11 - Modern Java UI library for both desktop and web.
...
* [Eclipse Collections](https://github.com/eclipse/eclipse-collections) ⭐ 2,611 | 🐛 177 | 🌐 Java | 📅 2026-02-12 - Collections framework inspired by Smalltalk.
...
* [Feign](https://github.com/OpenFeign/feign) ⭐ 9,789 | 🐛 235 | 🌐 Java | 📅 2026-02-12 - HTTP client binder inspired by Retrofit, JAXRS-2.0, and WebSocket.
...
* [methanol](https://github.com/mizosoft/methanol) ⭐ 289 | 🐛 17 | 🌐 Java | 📅 2026-01-31 - HTTP client extensions library.
...
* [Spring HATEOAS](https://github.com/spring-projects/spring-hateoas) ⭐ 1,079 | 🐛 277 | 🌐 Java | 📅 2026-01-26 - Standalone and Spring support for building hypermedia-based APIs using HAL, HAL FORMS, Collection+JSON, ALPS and UBER.
...
* [ZXing](https://github.com/zxing/zxing) ⭐ 33,853 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - Multi-format 1D/2D barcode image processing library.
* [Thumbnailator](https://github.com/coobird/thumbnailator) ⭐ 5,384 | 🐛 53 | 🌐 Java | 📅 2026-01-08 - High-quality thumbnail generation library.
* [TwelveMonkeys](https://github.com/haraldk/TwelveMonkeys) ⭐ 2,091 | 🐛 62 | 🌐 Java | 📅 2026-02-09 - Collection of plugins that extend the number of supported image file formats.
...
* [Quartz](https://github.com/quartz-scheduler/quartz) ⭐ 6,687 | 🐛 70 | 🌐 Java | 📅 2026-01-30 - Feature-rich, open source job scheduling library that can be integrated within virtually any Java application.
* [shedlock](https://github.com/lukas-krecan/ShedLock) ⭐ 4,094 | 🐛 21 | 🌐 Java | 📅 2026-02-12 - Makes sure that your scheduled tasks are executed at most once at the same time. If a task is being executed on one node, it acquires a lock which prevents execution of the same task from another node or thread.
* [JobRunr](https://github.com/jobrunr/jobrunr) ⭐ 2,866 | 🐛 5 | 🌐 Java | 📅 2026-02-10 - Job scheduling library which utilizes lambdas for fire-and-forget, delayed and recurring jobs. Guarantees execution by single scheduler instance using optimistic locking. Has features for persistence, minimal dependencies and is embeddable.
* [db-scheduler](https://github.com/kagkarlsson/db-scheduler) ⭐ 1,499 | 🐛 92 | 🌐 Java | 📅 2026-02-12 - Persistent and cluster-friendly scheduler.
...
* [Gson](https://github.com/google/gson) ⭐ 24,343 | 🐛 332 | 🌐 Java | 📅 2026-02-01 - Serializes objects to JSON and vice versa. Good performance with on-the-fly usage.
* [Moshi](https://github.com/square/moshi) ⭐ 10,106 | 🐛 97 | 🌐 Kotlin | 📅 2026-02-05 - Modern JSON library, less opinionated and uses built-in types like List and Map.
* [Jackson](https://github.com/FasterXML/jackson) ⭐ 9,665 | 🐛 1 | 📅 2026-02-13 - Similar to GSON, but offers performance gains if you need to instantiate the library more often.
* [JsonPath](https://github.com/json-path/JsonPath) ⭐ 9,391 | 🐛 429 | 🌐 Java | 📅 2026-02-04 - Extract data from JSON using XPATH-like syntax.
...
* [Graal](https://github.com/oracle/graal) ⭐ 21,466 | 🐛 813 | 🌐 Java | 📅 2026-02-13 - Polyglot embeddable JVM. (GPL-2.0-only WITH Classpath-exception-2.0)
* [Dragonwell8](https://github.com/alibaba/dragonwell8) ⭐ 4,319 | 🐛 169 | 🌐 Java | 📅 2026-02-09 - Downstream version of OpenJDK optimized for online e-commerce, financial, logistics applications.
* [OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,503 | 🐛 3,019 | 🌐 Java | 📅 2026-02-12 - High performance, enterprise-calibre, flexibly licensed, openly-governed cross-platform JVM extending and augmenting the runtime technology components from the Eclipse OMR and OpenJDK project.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,823 | 🐛 550 | 🌐 Java | 📅 2026-02-12 - VM with non-blocking, concurrent GC for iOS. (GPL-2.0-only WITH Classpath-exception-2.0)
...
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,014 | 🐛 36 | 🌐 Java | 📅 2026-02-12 - Extensible, open-source library for HTTP request and response logging.
...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,339 | 🐛 6 | 🌐 Java | 📅 2026-02-11 - Statistical Machine Intelligence and Learning Engine provides a set of machine learning algorithms and a visualization library.
...
* [EventBus](https://github.com/greenrobot/EventBus) ⭐ 24,762 | 🐛 147 | 🌐 Java | 📅 2024-02-21 - Simple publish/subscribe event bus.
* [AutoMQ](https://github.com/AutoMQ/automq-for-kafka) ⭐ 9,492 | 🐛 83 | 🌐 Java | 📅 2026-02-13 - AutoMQ is a cloud-native, serverless reinvented Kafka that is easily scalable, manage-less and cost-effective.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,444 | 🐛 16 | 🌐 Java | 📅 2026-02-07 - Efficient, reliable, unicast and multicast message transport.
...
* [NATS client](https://github.com/nats-io/nats.java) ⭐ 647 | 🐛 6 | 🌐 Java | 📅 2026-02-12 - NATS client.
...
* [Sentinel](https://github.com/alibaba/Sentinel) ⭐ 23,065 | 🐛 839 | 🌐 Java | 📅 2026-01-26 - Flow control component enabling reliability, resilience and monitoring for microservices.
...
* [kubernetes-client](https://github.com/fabric8io/kubernetes-client) ⭐ 3,618 | 🐛 102 | 🌐 Java | 📅 2026-02-12 - Client provides access to the full Kubernetes & OpenShift REST APIs via a fluent DSL.
...
* [Design Patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 93,730 | 🐛 213 | 🌐 Java | 📅 2026-02-10 - Implementation and explanation of the most common design patterns.
...
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,039 | 🐛 99 | 🌐 Java | 📅 2026-02-11 - Java-to-Objective-C translator for porting Android libraries to iOS.
...
* [Svix](https://github.com/svix/svix-webhooks/tree/main/java) ⭐ 3,101 | 🐛 57 | 🌐 Rust | 📅 2026-02-12 - Library for the Svix API to send webhooks and verify signatures.
* [Jimfs](https://github.com/google/jimfs) ⭐ 2,528 | 🐛 37 | 🌐 Java | 📅 2026-02-09 - In-memory file system.
...
* [FF4J](https://github.com/ff4j/ff4j) ⭐ 1,444 | 🐛 40 | 🌐 Java | 📅 2026-02-10 - Feature Flags for Java.
* [Simple Java Mail](https://github.com/bbottema/simple-java-mail) ⭐ 1,289 | 🐛 39 | 🌐 Java | 📅 2025-06-02 - Mailing with a clean and fluent API.
...
* [Membrane Service Proxy](https://github.com/membrane/service-proxy) ⭐ 559 | 🐛 23 | 🌐 Java | 📅 2026-02-12 - Open-source, reverse-proxy framework.
...
* [Pinpoint](https://github.com/naver/pinpoint) ⭐ 13,805 | 🐛 513 | 🌐 Java | 📅 2026-02-13 - Open-source APM tool.
...
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,080 | 🐛 315 | 🌐 Java | 📅 2026-02-09 - Real-time monitoring system with custom-monitor and agentless.
...
* [Micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,804 | 🐛 283 | 🌐 Java | 📅 2026-02-12 - Vendor-neutral metrics/observability facade for the most popular metrics/observability libraries.
* [JavaMelody](https://github.com/javamelody/javamelody) ⭐ 3,034 | 🐛 46 | 🌐 Java | 📅 2026-02-02 - Performance monitoring and profiling.
* [OpenTelemetry](https://github.com/open-telemetry/opentelemetry-java) ⭐ 2,355 | 🐛 170 | 🌐 Java | 📅 2026-02-12 - Instrument, generate, collect, and export telemetry data to help you analyze your software’s performance and behavior.
* [Prometheus](https://github.com/prometheus/client_java) ⭐ 2,264 | 🐛 129 | 🌐 Java | 📅 2026-02-13 - Provides a multi-dimensional data model, DSL, autonomous server nodes and much more.
...
* [Sentry ![c]](https://github.com/getsentry/sentry-java) ⭐ 1,297 | 🐛 228 | 🌐 Kotlin | 📅 2026-02-13 - Integration with [Sentry](https://github.com/getsentry/sentry) ⭐ 43,144 | 🐛 2,031 | 🌐 Python | 📅 2026-02-13, an application error tracking and performance analysis platform.
* [Datadog ![c]](https://github.com/DataDog/dd-trace-java) ⭐ 691 | 🐛 309 | 🌐 Java | 📅 2026-02-12 - Modern monitoring & analytics.
...
* [Micrometer Tracing](https://github.com/micrometer-metrics/tracing) ⭐ 290 | 🐛 25 | 🌐 Java | 📅 2026-02-12 - Vendor-neutral distributed tracing facade for the most popular tracer libraries.
...
* [Dubbo](https://github.com/apache/dubbo) ⭐ 41,726 | 🐛 911 | 🌐 Java | 📅 2026-02-10 - High-performance RPC framework.
* [gRPC-java](https://github.com/grpc/grpc-java) ⭐ 11,974 | 🐛 500 | 🌐 Java | 📅 2026-02-12 - RPC framework based on protobuf and HTTP/2.
* [sshj](https://github.com/hierynomus/sshj) ⭐ 2,633 | 🐛 280 | 🌐 Java | 📅 2025-05-14 - Programmatically use SSH, SCP or SFTP.
...
* [ServiceTalk](https://github.com/apple/servicetalk) ⭐ 1,019 | 🐛 74 | 🌐 Java | 📅 2026-02-09 - Framework built on Netty with APIs tailored to specific protocols and support for multiple programming paradigms.
...
* [MyBatis](https://github.com/mybatis/mybatis-3) ⭐ 20,379 | 🐛 199 | 🌐 Java | 📅 2026-02-12 - Couples objects with stored procedures or SQL statements.
...
* [Doma](https://github.com/domaframework/doma) ⭐ 493 | 🐛 3 | 🌐 Java | 📅 2026-02-12 - Database access framework that verifies and generates source code at compile time using annotation processing as well as native SQL templates called two-way SQL.
...
* [flyingsaucer](https://github.com/flyingsaucerproject/flyingsaucer) ⭐ 2,198 | 🐛 41 | 🌐 Java | 📅 2026-02-06 - XML/XHTML and CSS 2.1 renderer. (LGPL-2.1-or-later)
* [Tabula](https://github.com/tabulapdf/tabula-java) ⭐ 2,007 | 🐛 194 | 🌐 Java | 📅 2025-03-19 - Extracts tables from PDF files.
...
* [Light-4J](https://github.com/networknt/light-4j/) ⭐ 3,681 | 🐛 29 | 🌐 Java | 📅 2026-02-12 - Fast, lightweight and productive microservices framework with built-in [security](https://github.com/networknt/light-oauth2/) ⚠️ Archived.
...
* [Reactive Streams](https://github.com/reactive-streams/reactive-streams-jvm) ⭐ 4,865 | 🐛 34 | 🌐 Java | 📅 2024-03-13 - Provides a standard for asynchronous stream processing with non-blocking backpressure.
* [Reactor](https://github.com/reactor/reactor) ⭐ 3,687 | 🐛 9 | 📅 2026-02-10 - A framework for building non-blocking applications on the JVM, providing support for reactive programming.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,805 | 🐛 5,586 | 🌐 Java | 📅 2026-02-12 - Allows generation of API client libraries, SDKs, server stubs, documentation and configuration automatically given an OpenAPI Spec.
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,595 | 🐛 34 | 🌐 Java | 📅 2026-02-12 - Opinionated framework for setting up modern web applications with Jetty, Jackson, Jersey and Metrics.
* [springdoc-openapi](https://github.com/springdoc/springdoc-openapi) ⭐ 3,666 | 🐛 22 | 🌐 Java | 📅 2026-02-10 - Automates the generation of API documentation using Spring Boot projects.
* [rest.li](https://github.com/linkedin/rest.li) ⭐ 2,534 | 🐛 110 | 🌐 Java | 📅 2026-02-13 - Framework for building robust, scalable RESTful architectures using typesafe bindings and asynchronous, non-blocking IO with an end-to-end developer workflow that promotes clean practices, uniform interface design and consistent data modeling.
...
* [Restlet Framework](https://github.com/restlet/restlet-framework-java) ⭐ 662 | 🐛 554 | 🌐 Java | 📅 2026-01-23 - Pioneering framework with powerful routing and filtering capabilities, and a unified client and server API.
...
* [jjwt](https://github.com/jwtk/jjwt) ⭐ 11,025 | 🐛 48 | 🌐 Java | 📅 2025-10-17 - JSON web token for Java and Android.
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 25,542 | 🐛 142 | 🌐 C++ | 📅 2026-02-12 - Memory-efficient serialization library that can access serialized data without unpacking and parsing it.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,486 | 🐛 35 | 🌐 HTML | 📅 2026-02-09 - Fast and efficient object graph serialization framework.
* [Fury](https://github.com/alipay/fury) ⭐ 4,206 | 🐛 156 | 🌐 Java | 📅 2026-02-13 - Blazing fast object graph serialization framework powered by JIT and zero-copy.
...
* [jte](https://github.com/casid/jte) ⭐ 1,078 | 🐛 50 | 🌐 Java | 📅 2026-02-10 - Compiles to classes, and uses an easy syntax, several features to make development easier and provides fast execution and a small footprint.
* [StringTemplate](https://github.com/antlr/stringtemplate4) ⭐ 1,025 | 🐛 48 | 🌐 Java | 📅 2025-05-14 - Template engine for generating source code, web pages, emails, or any other formatted text output.
* [Rocker](https://github.com/fizzed/rocker) ⭐ 782 | 🐛 48 | 🌐 Java | 📅 2026-01-21 - Optimized, memory efficient and speedy template engine producing statically typed, plain objects.
...
* [Karate](https://github.com/intuit/karate) ⭐ 8,781 | 🐛 70 | 🌐 Java | 📅 2026-02-05 - DSL that combines API test-automation, mocks and performance-testing making testing REST/HTTP services easy.
* [REST Assured](https://github.com/rest-assured/rest-assured) ⭐ 7,110 | 🐛 585 | 🌐 Java | 📅 2026-02-04 - DSL for easy testing of REST/HTTP services.
...
* [Cucumber](https://github.com/cucumber/cucumber-jvm) ⭐ 2,790 | 🐛 61 | 🌐 Java | 📅 2026-02-12 - Provides a way to describe features in a plain language which customers can understand.
* [Serenity BDD](https://github.com/serenity-bdd/serenity-core) ⭐ 748 | 🐛 436 | 🌐 HTML | 📅 2026-02-03 - Automated Acceptance testing and reporting library that works with Cucumber, JBehave and JUnit to make it easier to write high quality executable specifications.
...
* [Datafaker](https://github.com/datafaker-net/datafaker) ⭐ 1,735 | 🐛 8 | 🌐 Java | 📅 2026-02-12 - Modern fake data generator forked from Java Faker.
* [Instancio](https://github.com/instancio/instancio) ⭐ 1,105 | 🐛 8 | 🌐 Java | 📅 2026-02-13 - Automates data setup in unit tests by generating fully-populated, reproducible objects. Includes JUnit 5 extension.
...
* [Testcontainers](https://github.com/testcontainers/testcontainers-java) ⭐ 8,579 | 🐛 628 | 🌐 Java | 📅 2026-02-03 - Provides throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
...
* [Mockito](https://github.com/mockito/mockito) ⭐ 15,423 | 🐛 483 | 🌐 Java | 📅 2026-02-06 - Mocking framework that lets you write tests with a clean and simple API.
* [Moco](https://github.com/dreamhead/moco) ⭐ 4,432 | 🐛 144 | 🌐 Java | 📅 2026-02-04 - Concise web services for stubs and mocks.
* [PowerMock](https://github.com/powermock/powermock) ⭐ 4,188 | 🐛 463 | 🌐 Java | 📅 2024-01-03 - Mocks static methods, constructors, final classes and methods, private methods, and removal of static initializers.
...
* [Guava](https://github.com/google/guava) ⭐ 51,469 | 🐛 720 | 🌐 Java | 📅 2026-02-13 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and more.
* [Arthas](https://github.com/alibaba/arthas) ⭐ 37,093 | 🐛 461 | 🌐 Java | 📅 2026-02-03 - Allows to troubleshoot production issues for applications without modifying code or restarting servers.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,357 | 🐛 547 | 🌐 Java | 📅 2026-02-09 - Cross-platform for visualizing and manipulating large graph networks. (GPL-3.0-only)
* [bucket4j](https://github.com/vladimir-bukhtoyarov/bucket4j) ⭐ 2,692 | 🐛 23 | 🌐 Java | 📅 2026-02-04 - Rate limiting library based on token-bucket algorithm.
...
* [SDKMan](https://github.com/sdkman/sdkman-cli) ⭐ 6,658 | 🐛 189 | 🌐 Gherkin | 📅 2026-01-07 - Java Version Manager inspired by RVM and rbenv. Supports UNIX-based platforms and Windows.
...
* [Erupt](https://github.com/erupts/erupt) ⭐ 2,685 | 🐛 7 | 🌐 Java | 📅 2026-02-09 - Annotation-Driven Low-Code & JPA Visualization
* [Takes](https://github.com/yegor256/takes) ⭐ 870 | 🐛 106 | 🌐 Java | 📅 2026-02-12 - Opinionated web framework which is built around the concepts of True Object-Oriented Programming and immutability.
...
* [flowable](https://github.com/flowable/flowable-engine) ⭐ 9,081 | 🐛 385 | 🌐 Java | 📅 2026-02-04 - Compact and efficient workflow and business process management platform.
...
* [Awesome Microservices](https://github.com/mfornos/awesome-microservices) ⭐ 14,138 | 🐛 7 | 📅 2026-01-17
* [Useful Java Links](https://github.com/Vedenin/useful-java-links) ⭐ 6,144 | 🐛 17 | 🌐 Java | 📅 2025-07-12
* [Java Developer Roadmap](https://github.com/s4kibs4mi/java-developer-roadmap) ⭐ 4,412 | 🐛 0 | 🌐 Java | 📅 2026-01-26
...
Please have a look at the [CONTRIBUTING](https://github.com/akullpp/awesome-java/blob/master/CONTRIBUTING.md) ⭐ 47,009 | 🐛 3 | 📅 2026-02-07 guidelines and [the validation tools](https://github.com/akullpp/awesome-java-lint) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2020-07-19.
