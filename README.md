...
[Please find a different kind of layout here](https://github.com/akullpp/awesome-java/tree/test) ⭐ 47,020 | 🐛 3 | 📅 2026-02-07.

We are evaluating to make this the default, you can provide feedback here in [#1171](https://github.com/akullpp/awesome-java/issues/1171) ⭐ 47,020 | 🐛 3 | 📅 2026-02-07.
...
* [ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,598 | 🐛 180 | 🌐 Java | 📅 2026-02-11 - Test library for specifying and asserting architecture rules.
...
* [LangChain4j](https://github.com/langchain4j/langchain4j) ⭐ 10,747 | 🐛 657 | 🌐 Java | 📅 2026-02-12 - Simplifies integration of LLMs with unified APIs and a comprehensive toolbox.
* [MCP Java SDK](https://github.com/modelcontextprotocol/java-sdk) ⭐ 3,173 | 🐛 316 | 🌐 Java | 📅 2026-02-13 - Enables applications to interact with AI models and tools through a standardized interface (i.e. Model Context Protocol), supporting both synchronous and asynchronous communication patterns.
...
* [MapStruct](https://github.com/mapstruct/mapstruct) ⭐ 7,619 | 🐛 496 | 🌐 Java | 📅 2026-02-02 - Code generator that simplifies mappings between different bean types, based on a convention-over-configuration approach.
...
* [Buck2](https://github.com/facebook/buck2) ⭐ 4,251 | 🐛 345 | 🌐 Rust | 📅 2026-02-14 - Encourages the creation of small, reusable modules consisting of code and resources.
...
* [Caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,469 | 🐛 1 | 🌐 Java | 📅 2026-02-13 - High-performance, near-optimal caching library.
...
* [JLine](https://github.com/jline/jline3) ⭐ 1,716 | 🐛 69 | 🌐 Java | 📅 2026-02-13 - Includes features from modern shells like completion or history.
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,530 | 🐛 105 | 🌐 Java | 📅 2025-07-18 - Easy console text-GUI library, similar to curses. (LGPL-3.0-only)
...
* [Google Cloud Client Libraries](https://github.com/googleapis/google-cloud-java) ⭐ 2,013 | 🐛 139 | 🌐 Java | 📅 2026-02-14 - Client libraries for accessing Google Cloud services from Java applications.
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,516 | 🐛 408 | 🌐 OCaml | 📅 2026-02-13 - Modern static analysis tool for verifying the correctness of code.
* [Checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 8,857 | 🐛 939 | 🌐 Java | 📅 2026-02-14 - Static analysis of coding conventions and standards. (LGPL-2.1-or-later)
...
* [PMD](https://github.com/pmd/pmd) ⭐ 5,315 | 🐛 623 | 🌐 Java | 📅 2026-02-11 - Source code analysis for finding bad coding practices.
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,005 | 🐛 132 | 🌐 Java | 📅 2026-02-14 - Eliminates NullPointerExceptions with low build-time overhead.
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,823 | 🐛 458 | 🌐 Java | 📅 2026-02-12 - Static analysis of bytecode to find potential bugs. (LGPL-2.1-only)
* [Spoon](https://github.com/INRIA/spoon) ⭐ 1,901 | 🐛 357 | 🌐 Java | 📅 2026-02-13 - Library for analyzing and transforming Java source code.
* [SonarJava](https://github.com/SonarSource/sonar-java) ⭐ 1,190 | 🐛 13 | 🌐 Java | 📅 2026-02-13 - Static analyzer for SonarQube & SonarLint. (LGPL-3.0-only)
...
* [Error Prone Support](https://github.com/PicnicSupermarket/error-prone-support) ⭐ 232 | 🐛 54 | 🌐 Java | 📅 2026-02-13 - Error Prone extensions: extra bug checkers and a large battery of Refaster templates.
...
* [JHipster](https://github.com/jhipster/generator-jhipster) ⭐ 22,345 | 🐛 139 | 🌐 TypeScript | 📅 2026-02-14 - Yeoman source code generator for Spring Boot and AngularJS.
...
* [Record-Builder](https://github.com/Randgalt/record-builder) ⭐ 908 | 🐛 33 | 🌐 Java | 📅 2026-01-26 - Companion builder class, withers and templates for Java records.
...
* [owner](https://github.com/lviggiano/owner) ⭐ 933 | 🐛 135 | 🌐 Java | 📅 2026-02-02 - Reduces boilerplate of properties.
...
* [JaCoP](https://github.com/radsz/jacop) ⭐ 232 | 🐛 9 | 🌐 Java | 📅 2026-02-11 - Includes an interface for the FlatZinc language, enabling it to execute MiniZinc models. (AGPL-3.0)
...
* [uniVocity-parsers](https://github.com/uniVocity/univocity-parsers) ⭐ 933 | 🐛 103 | 🌐 Java | 📅 2024-08-17 - One of the fastest and most feature-complete parsers. Also comes with parsers for TSV and fixed-width records.
...
* [Protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,679 | 🐛 235 | 🌐 C++ | 📅 2026-02-14 - Google's data interchange format.
...
* [SBE](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,390 | 🐛 37 | 🌐 Java | 📅 2026-01-30 - Simple Binary Encoding, one of the fastest message formats around.
...
* [Redisson](https://github.com/redisson/redisson) ⭐ 24,244 | 🐛 291 | 🌐 Java | 📅 2026-02-12 - Allows for distributed and scalable data structures on top of a Redis server.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,010 | 🐛 526 | 🌐 Java | 📅 2025-11-04 - High-performance JDBC connection pool.
...
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,675 | 🐛 799 | 🌐 Java | 📅 2026-02-14 - High-performance SQL database for time series. Supports InfluxDB line protocol, PostgreSQL wire protocol, and REST.
* [Jedis](https://github.com/xetorthio/jedis) ⭐ 12,281 | 🐛 96 | 🌐 Java | 📅 2026-02-13 - Small client for interaction with Redis, with methods for commands.
...
* [eXist](https://github.com/eXist-db/exist) ⭐ 460 | 🐛 565 | 🌐 Java | 📅 2026-02-11 - NoSQL document database and application platform. (LGPL-2.1-only)
* [OpenDJ](https://github.com/OpenIdentityPlatform/OpenDJ) ⭐ 427 | 🐛 7 | 🌐 Java | 📅 2026-02-11 - LDAPv3 compliant directory service, developed for the Java platform, providing a high performance, highly available, and secure store for the identities.
...
* [java-tron](https://github.com/tronprotocol/java-tron) ⭐ 4,028 | 🐛 35 | 🌐 Java | 📅 2026-02-04 Implementation of the Tron Protocol, whic utilizes blockchains to develop decentralized applications.
...
* [JavaParser](https://github.com/javaparser/javaparser) ⭐ 6,048 | 🐛 448 | 🌐 Java | 📅 2026-02-09 - Parse, modify and generate Java code.
...
* [HotswapAgent](https://github.com/HotswapProjects/HotswapAgent) ⭐ 2,569 | 🐛 106 | 🌐 Java | 📅 2026-02-09 - Unlimited runtime class and resource redefinition. (GPL-2.0-only)
...
* [Zuul](https://github.com/Netflix/zuul) ⭐ 13,984 | 🐛 10 | 🌐 Java | 📅 2026-02-13 - Gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
* [resilience4j](https://github.com/resilience4j/resilience4j) ⭐ 10,547 | 🐛 277 | 🌐 Java | 📅 2026-02-06 - Functional fault tolerance library.
* [Hazelcast](https://github.com/hazelcast/hazelcast) ⭐ 6,589 | 🐛 1,099 | 🌐 Java | 📅 2026-02-13 - Highly scalable in-memory datagrid with a free open-source version.
...
* [Seata](https://github.com/seata/seata) ⭐ 25,944 | 🐛 868 | 🌐 Java | 📅 2026-02-10 - Delivers high performance and easy to use distributed transaction services under a microservices architecture.
...
* [fastexcel](https://github.com/dhatim/fastexcel) ⭐ 858 | 🐛 72 | 🌐 Java | 📅 2026-02-02 - High performance library to read and write large Excel (XLSX) worksheets.
...
* [Stripe](https://github.com/stripe/stripe-java) ⭐ 950 | 🐛 26 | 🌐 Java | 📅 2026-02-13 - Integration with the Stripe API.
...
* [Philadelphia](https://github.com/paritytrading/philadelphia) ⭐ 340 | 🐛 4 | 🌐 Java | 📅 2026-02-13 - Low-latency financial information exchange.
...
* [GraphHopper](https://github.com/graphhopper/graphhopper) ⭐ 6,267 | 🐛 255 | 🌐 Java | 📅 2026-02-13 - Road-routing engine. Used as a Java library or standalone web service.
...
* [SnapKit](https://github.com/reportmill/SnapKit) ⭐ 313 | 🐛 2 | 🌐 Java | 📅 2026-02-13 - Modern Java UI library for both desktop and web.
...
* [JCTools](https://github.com/JCTools/JCTools) ⭐ 3,804 | 🐛 54 | 🌐 Java | 📅 2026-02-08 - Concurrency tools currently missing from the JDK.
* [Agrona](https://github.com/real-logic/Agrona) ⭐ 3,151 | 🐛 2 | 🌐 Java | 📅 2026-02-11 - Data structures and utility methods that are common in high-performance applications.
...
* [ZXing](https://github.com/zxing/zxing) ⭐ 33,852 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - Multi-format 1D/2D barcode image processing library.
* [Thumbnailator](https://github.com/coobird/thumbnailator) ⭐ 5,384 | 🐛 53 | 🌐 Java | 📅 2026-01-08 - High-quality thumbnail generation library.
...
* [Quartz](https://github.com/quartz-scheduler/quartz) ⭐ 6,687 | 🐛 72 | 🌐 Java | 📅 2026-01-30 - Feature-rich, open source job scheduling library that can be integrated within virtually any Java application.
...
* [JobRunr](https://github.com/jobrunr/jobrunr) ⭐ 2,866 | 🐛 4 | 🌐 Java | 📅 2026-02-13 - Job scheduling library which utilizes lambdas for fire-and-forget, delayed and recurring jobs. Guarantees execution by single scheduler instance using optimistic locking. Has features for persistence, minimal dependencies and is embeddable.
...
* [Gson](https://github.com/google/gson) ⭐ 24,343 | 🐛 331 | 🌐 Java | 📅 2026-02-13 - Serializes objects to JSON and vice versa. Good performance with on-the-fly usage.
* [Moshi](https://github.com/square/moshi) ⭐ 10,107 | 🐛 97 | 🌐 Kotlin | 📅 2026-02-05 - Modern JSON library, less opinionated and uses built-in types like List and Map.
...
* [Graal](https://github.com/oracle/graal) ⭐ 21,466 | 🐛 812 | 🌐 Java | 📅 2026-02-14 - Polyglot embeddable JVM. (GPL-2.0-only WITH Classpath-exception-2.0)
...
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,822 | 🐛 551 | 🌐 Java | 📅 2026-02-13 - VM with non-blocking, concurrent GC for iOS. (GPL-2.0-only WITH Classpath-exception-2.0)
...
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,014 | 🐛 36 | 🌐 Java | 📅 2026-02-13 - Extensible, open-source library for HTTP request and response logging.
...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,338 | 🐛 6 | 🌐 Java | 📅 2026-02-11 - Statistical Machine Intelligence and Learning Engine provides a set of machine learning algorithms and a visualization library.
...
* [AutoMQ](https://github.com/AutoMQ/automq-for-kafka) ⭐ 9,500 | 🐛 84 | 🌐 Java | 📅 2026-02-13 - AutoMQ is a cloud-native, serverless reinvented Kafka that is easily scalable, manage-less and cost-effective.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,443 | 🐛 16 | 🌐 Java | 📅 2026-02-07 - Efficient, reliable, unicast and multicast message transport.
* [JeroMQ](https://github.com/zeromq/jeromq) ⭐ 2,441 | 🐛 101 | 🌐 Java | 📅 2025-11-30 - Implementation of ZeroMQ.
* [Smack](https://github.com/igniterealtime/Smack) ⭐ 2,417 | 🐛 32 | 🌐 Java | 📅 2025-12-02 - Cross-platform XMPP client library.
* [RabbitMQ Java client](https://github.com/rabbitmq/rabbitmq-java-client) ⭐ 1,298 | 🐛 21 | 🌐 Java | 📅 2026-02-10 - RabbitMQ client.
...
* [Eureka](https://github.com/Netflix/eureka) ⭐ 12,699 | 🐛 137 | 🌐 Java | 📅 2026-01-23 - REST-based service registry for resilient load balancing and failover.
* [Armeria](https://github.com/line/armeria) ⭐ 5,071 | 🐛 703 | 🌐 Java | 📅 2026-02-12 - Asynchronous RPC/REST client/server library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC.
* [OpenAI-Java](https://github.com/TheoKanning/openai-java) ⚠️ Archived - Java libraries for using OpenAI's GPT-3 API.
* [JDA](https://github.com/DV8FromTheWorld/JDA) ⭐ 4,628 | 🐛 60 | 🌐 Java | 📅 2026-02-08 - Wrapping of the Discord REST API and its WebSocket events.
...
* [Design Patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 93,733 | 🐛 213 | 🌐 Java | 📅 2026-02-10 - Implementation and explanation of the most common design patterns.
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,263 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - No-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes. (No explicit license)
* [Modern Java - A Guide to Java 8](https://github.com/winterbe/java8-tutorial) ⭐ 16,782 | 🐛 19 | 🌐 Java | 📅 2023-08-11 - Popular Java 8 guide.
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,037 | 🐛 99 | 🌐 Java | 📅 2026-02-11 - Java-to-Objective-C translator for porting Android libraries to iOS.
...
* [Svix](https://github.com/svix/svix-webhooks/tree/main/java) ⭐ 3,104 | 🐛 60 | 🌐 Rust | 📅 2026-02-12 - Library for the Svix API to send webhooks and verify signatures.
* [Jimfs](https://github.com/google/jimfs) ⭐ 2,530 | 🐛 37 | 🌐 Java | 📅 2026-02-09 - In-memory file system.
...
* [Simple Java Mail](https://github.com/bbottema/simple-java-mail) ⭐ 1,288 | 🐛 39 | 🌐 Java | 📅 2025-06-02 - Mailing with a clean and fluent API.
* [JBot](https://github.com/rampatra/jbot) ⭐ 1,205 | 🐛 78 | 🌐 Java | 📅 2025-10-08 - Framework for building chatbots. (GPL-3.0-only)
* [Polyglot for Maven](https://github.com/takari/polyglot-maven) ⭐ 917 | 🐛 46 | 🌐 Java | 📅 2025-11-20 - Extensions for Maven 3.3.1+ that allows writing the POM model in dialects other than XML.
* [TypeTools](https://github.com/jhalterman/typetools) ⭐ 630 | 🐛 24 | 🌐 Java | 📅 2023-04-12 - Tools for resolving generic types.
* [Membrane Service Proxy](https://github.com/membrane/service-proxy) ⭐ 559 | 🐛 22 | 🌐 Java | 📅 2026-02-13 - Open-source, reverse-proxy framework.
...
* [Dropwizard Metrics](https://github.com/dropwizard/metrics) ⭐ 7,855 | 🐛 17 | 🌐 Java | 📅 2026-02-10 - Expose metrics via JMX or HTTP and send them to a database.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,080 | 🐛 314 | 🌐 Java | 📅 2026-02-13 - Real-time monitoring system with custom-monitor and agentless.
* [hippo4j](https://github.com/opengoofy/hippo4j/blob/develop/README-EN.md) ⭐ 5,987 | 🐛 140 | 🌐 Java | 📅 2025-10-31 - Dynamic and observable thread pool framework.
* [Micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,806 | 🐛 284 | 🌐 Java | 📅 2026-02-13 - Vendor-neutral metrics/observability facade for the most popular metrics/observability libraries.
* [JavaMelody](https://github.com/javamelody/javamelody) ⭐ 3,034 | 🐛 46 | 🌐 Java | 📅 2026-02-02 - Performance monitoring and profiling.
* [OpenTelemetry](https://github.com/open-telemetry/opentelemetry-java) ⭐ 2,356 | 🐛 170 | 🌐 Java | 📅 2026-02-13 - Instrument, generate, collect, and export telemetry data to help you analyze your software’s performance and behavior.
...
* [Sentry ![c]](https://github.com/getsentry/sentry-java) ⭐ 1,297 | 🐛 222 | 🌐 Kotlin | 📅 2026-02-13 - Integration with [Sentry](https://github.com/getsentry/sentry) ⭐ 43,146 | 🐛 2,050 | 🌐 Python | 📅 2026-02-14, an application error tracking and performance analysis platform.
...
* [JNA](https://github.com/java-native-access/jna) ⭐ 8,892 | 🐛 119 | 🌐 Java | 📅 2026-01-01 - Work with native libraries without writing JNI. Also provides interfaces to common system libraries.
...
* [Dubbo](https://github.com/apache/dubbo) ⭐ 41,728 | 🐛 912 | 🌐 Java | 📅 2026-02-10 - High-performance RPC framework.
* [gRPC-java](https://github.com/grpc/grpc-java) ⭐ 11,977 | 🐛 501 | 🌐 Java | 📅 2026-02-12 - RPC framework based on protobuf and HTTP/2.
...
* [TLS Channel](https://github.com/marianobarrios/tls-channel) ⭐ 208 | 🐛 3 | 🌐 Java | 📅 2026-02-10 - Implements a ByteChannel interface over SSLEngine, enabling easy-to-use (socket-like) TLS.
...
* [MyBatis](https://github.com/mybatis/mybatis-3) ⭐ 20,380 | 🐛 199 | 🌐 Java | 📅 2026-02-14 - Couples objects with stored procedures or SQL statements.
* [MyBatis-Plus](https://github.com/baomidou/mybatis-plus) ⭐ 17,299 | 🐛 107 | 🌐 Java | 📅 2026-02-07 - A powerful enhanced toolkit of MyBatis for simplifying development.
...
* [Doma](https://github.com/domaframework/doma) ⭐ 493 | 🐛 4 | 🌐 Java | 📅 2026-02-13 - Database access framework that verifies and generates source code at compile time using annotation processing as well as native SQL templates called two-way SQL.
...
* [Pathetic](https://github.com/bsommerfeld/pathetic) ⭐ 246 | 🐛 0 | 🌐 Java | 📅 2026-02-11 - A highly configurable 3D A\* pathfinding library that uses specific optimizations for high performance.

### PDF

*Tools to help with PDF files.*

* [OpenPDF](https://github.com/LibrePDF/OpenPDF) ⭐ 4,181 | 🐛 162 | 🌐 Java | 📅 2025-10-27 - Open-source iText fork. (LGPL-3.0-only & MPL-2.0)
...
* [Tabula](https://github.com/tabulapdf/tabula-java) ⭐ 2,008 | 🐛 194 | 🌐 Java | 📅 2025-03-19 - Extracts tables from PDF files.
...
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,527 | 🐛 20 | 🌐 Java | 📅 2026-02-06 - Allows for composing asynchronous and event-based programs using observable sequences.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,808 | 🐛 5,581 | 🌐 Java | 📅 2026-02-14 - Allows generation of API client libraries, SDKs, server stubs, documentation and configuration automatically given an OpenAPI Spec.
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,596 | 🐛 35 | 🌐 Java | 📅 2026-02-13 - Opinionated framework for setting up modern web applications with Jetty, Jackson, Jersey and Metrics.
* [springdoc-openapi](https://github.com/springdoc/springdoc-openapi) ⭐ 3,668 | 🐛 22 | 🌐 Java | 📅 2026-02-10 - Automates the generation of API documentation using Spring Boot projects.
...
* [Tablesaw](https://github.com/jtablesaw/tablesaw) ⭐ 3,733 | 🐛 141 | 🌐 Java | 📅 2025-07-12 - Includes a data-frame, an embedded column store, and hundreds of methods to transform, summarize, or filter data.
...
* [Chart-FX](https://github.com/GSI-CS-CO/chart-fx) ⭐ 583 | 🐛 27 | 🌐 Java | 📅 2025-12-10 - Scientific charting library with focus on performance optimised real-time data visualisation at 25 Hz update rates for large data sets.
...
* [jjwt](https://github.com/jwtk/jjwt) ⭐ 11,027 | 🐛 48 | 🌐 Java | 📅 2025-10-17 - JSON web token for Java and Android.
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 25,543 | 🐛 142 | 🌐 C++ | 📅 2026-02-12 - Memory-efficient serialization library that can access serialized data without unpacking and parsing it.
...
* [Fury](https://github.com/alipay/fury) ⭐ 4,206 | 🐛 160 | 🌐 Java | 📅 2026-02-14 - Blazing fast object graph serialization framework powered by JIT and zero-copy.
...
* [MessagePack](https://github.com/msgpack/msgpack-java) ⭐ 1,465 | 🐛 73 | 🌐 Java | 📅 2026-01-05 - Efficient binary serialization format.
...
* [jte](https://github.com/casid/jte) ⭐ 1,079 | 🐛 50 | 🌐 Java | 📅 2026-02-10 - Compiles to classes, and uses an easy syntax, several features to make development easier and provides fast execution and a small footprint.
...
* [Karate](https://github.com/intuit/karate) ⭐ 8,783 | 🐛 70 | 🌐 Java | 📅 2026-02-05 - DSL that combines API test-automation, mocks and performance-testing making testing REST/HTTP services easy.
* [REST Assured](https://github.com/rest-assured/rest-assured) ⭐ 7,108 | 🐛 585 | 🌐 Java | 📅 2026-02-04 - DSL for easy testing of REST/HTTP services.
...
* [Cucumber](https://github.com/cucumber/cucumber-jvm) ⭐ 2,791 | 🐛 61 | 🌐 Java | 📅 2026-02-12 - Provides a way to describe features in a plain language which customers can understand.
...
* [Instancio](https://github.com/instancio/instancio) ⭐ 1,105 | 🐛 7 | 🌐 Java | 📅 2026-02-13 - Automates data setup in unit tests by generating fully-populated, reproducible objects. Includes JUnit 5 extension.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 980 | 🐛 18 | 🌐 Java | 📅 2026-02-13 - Library that simplifies JSON comparison in tests.
...
* [Testcontainers](https://github.com/testcontainers/testcontainers-java) ⭐ 8,582 | 🐛 626 | 🌐 Java | 📅 2026-02-03 - Provides throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
...
* [PowerMock](https://github.com/powermock/powermock) ⭐ 4,188 | 🐛 462 | 🌐 Java | 📅 2024-01-03 - Mocks static methods, constructors, final classes and methods, private methods, and removal of static initializers.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,359 | 🐛 545 | 🌐 Java | 📅 2026-02-13 - Cross-platform for visualizing and manipulating large graph networks. (GPL-3.0-only)
...
* [dregex](https://github.com/marianobarrios/dregex) ⭐ 49 | 🐛 1 | 🌐 Java | 📅 2026-02-10 - Regular expression engine that uses deterministic finite automata. It supports some Perl-style features and yet retains linear matching time, and also offers set operations.
...
* [Erupt](https://github.com/erupts/erupt) ⭐ 2,686 | 🐛 7 | 🌐 Java | 📅 2026-02-09 - Annotation-Driven Low-Code & JPA Visualization
* [Takes](https://github.com/yegor256/takes) ⭐ 870 | 🐛 106 | 🌐 Java | 📅 2026-02-13 - Opinionated web framework which is built around the concepts of True Object-Oriented Programming and immutability.
...
* [flowable](https://github.com/flowable/flowable-engine) ⭐ 9,083 | 🐛 386 | 🌐 Java | 📅 2026-02-13 - Compact and efficient workflow and business process management platform.
...
* [Java Developer Roadmap](https://github.com/s4kibs4mi/java-developer-roadmap) ⭐ 4,414 | 🐛 0 | 🌐 Java | 📅 2026-01-26
...
* [Awesome J2ME](https://github.com/hstsethi/awesome-j2me) ⭐ 312 | 🐛 1 | 🌐 Java | 📅 2025-11-22
...
Please have a look at the [CONTRIBUTING](https://github.com/akullpp/awesome-java/blob/master/CONTRIBUTING.md) ⭐ 47,020 | 🐛 3 | 📅 2026-02-07 guidelines and [the validation tools](https://github.com/akullpp/awesome-java-lint) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2020-07-19.
