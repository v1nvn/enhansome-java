...
[Please find a different kind of layout here](https://github.com/akullpp/awesome-java/tree/test) ⭐ 47,037 | 🐛 3 | 📅 2026-02-07.

We are evaluating to make this the default, you can provide feedback here in [#1171](https://github.com/akullpp/awesome-java/issues/1171) ⭐ 47,037 | 🐛 3 | 📅 2026-02-07.
...
* [ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,598 | 🐛 181 | 🌐 Java | 📅 2026-02-11 - Test library for specifying and asserting architecture rules.
* [jMolecules](https://github.com/xmolecules/jmolecules) ⭐ 1,503 | 🐛 19 | 🌐 Java | 📅 2026-02-03 - Annotations and interfaces to express design and architecture concepts in code.

### Artificial Intelligence

*Frameworks that help you to leverage LLMs and AI.*

* [LangChain4j](https://github.com/langchain4j/langchain4j) ⭐ 10,756 | 🐛 658 | 🌐 Java | 📅 2026-02-12 - Simplifies integration of LLMs with unified APIs and a comprehensive toolbox.
* [MCP Java SDK](https://github.com/modelcontextprotocol/java-sdk) ⭐ 3,174 | 🐛 319 | 🌐 Java | 📅 2026-02-13 - Enables applications to interact with AI models and tools through a standardized interface (i.e. Model Context Protocol), supporting both synchronous and asynchronous communication patterns.
* [simple-openai](https://github.com/sashirestela/simple-openai) ⭐ 373 | 🐛 17 | 🌐 Java | 📅 2025-09-17 - Library to use the OpenAI API (and compatible ones) in the simplest possible way.
...
* [MapStruct](https://github.com/mapstruct/mapstruct) ⭐ 7,619 | 🐛 493 | 🌐 Java | 📅 2026-02-14 - Code generator that simplifies mappings between different bean types, based on a convention-over-configuration approach.
* [ModelMapper](https://github.com/modelmapper/modelmapper) ⭐ 2,347 | 🐛 257 | 🌐 Java | 📅 2025-11-11 - Intelligent object mapping library that automatically maps objects to each other.
...
* [Buck2](https://github.com/facebook/buck2) ⭐ 4,253 | 🐛 346 | 🌐 Rust | 📅 2026-02-15 - Encourages the creation of small, reusable modules consisting of code and resources.
...
* [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,422 | 🐛 100 | 🌐 Java | 📅 2026-01-07 - Java 8 Jar & Android APK reverse engineering suite. (GPL-3.0-only)
* [cglib](https://github.com/cglib/cglib) ⭐ 4,890 | 🐛 96 | 🌐 Java | 📅 2024-08-16 - Bytecode generation library.
* [Javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,229 | 🐛 251 | 🌐 Java | 📅 2024-10-03 - Tries to simplify bytecode editing.
* [Mixin](https://github.com/SpongePowered/Mixin) ⭐ 1,668 | 🐛 111 | 🌐 Java | 📅 2024-08-05 - Manipulate bytecode at runtime using real Java code.
...
* [Maker](https://github.com/cojen/maker) ⭐ 65 | 🐛 0 | 🌐 Java | 📅 2026-02-14 - Provides low level bytecode generation.
...
* [Caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,474 | 🐛 1 | 🌐 Java | 📅 2026-02-15 - High-performance, near-optimal caching library.
...
* [JLine](https://github.com/jline/jline3) ⭐ 1,717 | 🐛 69 | 🌐 Java | 📅 2026-02-14 - Includes features from modern shells like completion or history.
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,530 | 🐛 106 | 🌐 Java | 📅 2025-07-18 - Easy console text-GUI library, similar to curses. (LGPL-3.0-only)
...
* [AWS SDK for Java](https://github.com/aws/aws-sdk-java) ⭐ 4,197 | 🐛 1 | 🌐 Java | 📅 2026-01-05 - Provides Java APIs for interacting with Amazon Web Services.
* [Google Cloud Client Libraries](https://github.com/googleapis/google-cloud-java) ⭐ 2,013 | 🐛 139 | 🌐 Java | 📅 2026-02-15 - Client libraries for accessing Google Cloud services from Java applications.

### Code Analysis

*Tools that provide metrics and quality measurements.*

* [p3c](https://github.com/alibaba/p3c) ⭐ 30,826 | 🐛 186 | 🌐 Kotlin | 📅 2024-08-06 - Provides Alibaba's coding guidelines for PMD, IDEA and Eclipse.
* [Infer](https://github.com/facebook/infer) ⭐ 15,518 | 🐛 408 | 🌐 OCaml | 📅 2026-02-13 - Modern static analysis tool for verifying the correctness of code.
* [Checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 8,860 | 🐛 943 | 🌐 Java | 📅 2026-02-15 - Static analysis of coding conventions and standards. (LGPL-2.1-or-later)
* [Error Prone](https://github.com/google/error-prone) ⭐ 7,135 | 🐛 464 | 🌐 Java | 📅 2026-02-13 - Catches common programming mistakes as compile-time errors.
* [PMD](https://github.com/pmd/pmd) ⭐ 5,318 | 🐛 624 | 🌐 Java | 📅 2026-02-11 - Source code analysis for finding bad coding practices.
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,005 | 🐛 134 | 🌐 Java | 📅 2026-02-15 - Eliminates NullPointerExceptions with low build-time overhead.
* [Spotbugs](https://github.com/spotbugs/spotbugs) ⭐ 3,823 | 🐛 457 | 🌐 Java | 📅 2026-02-15 - Static analysis of bytecode to find potential bugs. (LGPL-2.1-only)
* [Spoon](https://github.com/INRIA/spoon) ⭐ 1,901 | 🐛 358 | 🌐 Java | 📅 2026-02-15 - Library for analyzing and transforming Java source code.
* [SonarJava](https://github.com/SonarSource/sonar-java) ⭐ 1,190 | 🐛 13 | 🌐 Java | 📅 2026-02-14 - Static analyzer for SonarQube & SonarLint. (LGPL-3.0-only)
* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 509 | 🐛 62 | 🌐 Java | 📅 2026-01-15 - Identifies and prioritizes God Classes and Highly Coupled classes.
* [Error Prone Support](https://github.com/PicnicSupermarket/error-prone-support) ⭐ 232 | 🐛 56 | 🌐 Java | 📅 2026-02-15 - Error Prone extensions: extra bug checkers and a large battery of Refaster templates.
...
* [JHipster](https://github.com/jhipster/generator-jhipster) ⭐ 22,345 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-15 - Yeoman source code generator for Spring Boot and AngularJS.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - API to generate source files.
* [Auto](https://github.com/google/auto) ⭐ 10,554 | 🐛 87 | 🌐 Java | 📅 2026-02-13 - Generates factory, service, and value classes.
* [Record-Builder](https://github.com/Randgalt/record-builder) ⭐ 909 | 🐛 33 | 🌐 Java | 📅 2026-01-26 - Companion builder class, withers and templates for Java records.
...
* [EasyEntityToDTO](https://github.com/Marcel091004/EasyEntityToDTO) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2026-02-13 - Annotation processor for automatic DTO and Mapper generation with zero boilerplate.
...
* [JavaCV](https://github.com/bytedeco/javacv) ⭐ 8,288 | 🐛 467 | 🌐 Java | 📅 2026-02-09 - Java interface to OpenCV, FFmpeg, and much more.

### Configuration

*Libraries that provide external configuration.*

* [config](https://github.com/lightbend/config) ⭐ 6,290 | 🐛 239 | 🌐 Java | 📅 2026-01-15 - Configuration library supporting Java properties, JSON or its human optimized superset HOCON.
* [owner](https://github.com/lviggiano/owner) ⭐ 934 | 🐛 135 | 🌐 Java | 📅 2026-02-02 - Reduces boilerplate of properties.
* [centraldogma](https://github.com/line/centraldogma) ⭐ 654 | 🐛 163 | 🌐 Java | 📅 2026-02-13 - Highly-available version-controlled service configuration repository based on Git, ZooKeeper and HTTP/2.
...
* [Gestalt](https://github.com/gestalt-config/gestalt) ⭐ 97 | 🐛 14 | 🌐 Java | 📅 2026-01-29 - Gestalt offers a comprehensive solution to the challenges of configuration management. It allows you to source configuration data from multiple inputs, merge them intelligently, and present them in a structured, type-safe manner.
...
* [JaCoP](https://github.com/radsz/jacop) ⭐ 232 | 🐛 9 | 🌐 Java | 📅 2026-02-15 - Includes an interface for the FlatZinc language, enabling it to execute MiniZinc models. (AGPL-3.0)
...
* [uniVocity-parsers](https://github.com/uniVocity/univocity-parsers) ⭐ 934 | 🐛 103 | 🌐 Java | 📅 2024-08-17 - One of the fastest and most feature-complete parsers. Also comes with parsers for TSV and fixed-width records.
...
* [Protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,685 | 🐛 238 | 🌐 C++ | 📅 2026-02-15 - Google's data interchange format.
* [Wire](https://github.com/square/wire) ⭐ 4,406 | 🐛 168 | 🌐 Kotlin | 📅 2026-02-11 - Clean, lightweight protocol buffers.
* [RoaringBitmap](https://github.com/RoaringBitmap/RoaringBitmap) ⭐ 3,818 | 🐛 75 | 🌐 Java | 📅 2026-01-23 - Fast and efficient compressed bitmap.
* [SBE](https://github.com/real-logic/simple-binary-encoding) ⭐ 3,392 | 🐛 37 | 🌐 Java | 📅 2026-01-30 - Simple Binary Encoding, one of the fastest message formats around.
...
* [Redisson](https://github.com/redisson/redisson) ⭐ 24,246 | 🐛 291 | 🌐 Java | 📅 2026-02-12 - Allows for distributed and scalable data structures on top of a Redis server.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,012 | 🐛 527 | 🌐 Java | 📅 2025-11-04 - High-performance JDBC connection pool.
* [Apache ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,675 | 🐛 350 | 🌐 Java | 📅 2026-02-14 - Distributed SQL transaction & query engine that allows for data sharding, scaling, encryption, and more on any database.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,678 | 🐛 799 | 🌐 Java | 📅 2026-02-15 - High-performance SQL database for time series. Supports InfluxDB line protocol, PostgreSQL wire protocol, and REST.
* [Jedis](https://github.com/xetorthio/jedis) ⭐ 12,280 | 🐛 96 | 🌐 Java | 📅 2026-02-13 - Small client for interaction with Redis, with methods for commands.
* [Realm](https://github.com/realm/realm-java) ⭐ 11,493 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - Mobile database to run directly inside phones, tablets or wearables.
* [Leaf](https://github.com/Meituan-Dianping/Leaf) ⭐ 6,730 | 🐛 95 | 🌐 Java | 📅 2023-07-18 - Distributed ID generate service.
* [requery](https://github.com/requery/requery) ⭐ 3,121 | 🐛 172 | 🌐 Java | 📅 2026-02-09 - Modern, lightweight but powerful object mapping and SQL generator. Easily map to or create databases, or perform queries and updates from any Java-using platform.
* [Chronicle Map](https://github.com/OpenHFT/Chronicle-Map) ⭐ 2,938 | 🐛 24 | 🌐 Java | 📅 2026-01-29 - Efficient, in-memory (opt. persisted to disk), off-heap key-value store.
* [Jest](https://github.com/searchbox-io/Jest) ⚠️ Archived - Client for the Elasticsearch REST API.
* [Speedment](https://github.com/speedment/speedment) ⭐ 2,096 | 🐛 95 | 🌐 Java | 📅 2023-11-07 - Database access library that utilizes Java 8's Stream API for querying.
...
* [FlexyPool](https://github.com/vladmihalcea/flexy-pool) ⭐ 1,169 | 🐛 5 | 🌐 Java | 📅 2025-11-28 - Brings metrics and failover strategies to the most common connection pooling solutions.
...
* [CosId](https://github.com/Ahoo-Wang/CosId) ⭐ 606 | 🐛 10 | 🌐 Java | 📅 2026-02-14 - Universal, flexible, high-performance distributed ID generator.
* [eXist](https://github.com/eXist-db/exist) ⭐ 460 | 🐛 563 | 🌐 Java | 📅 2026-02-11 - NoSQL document database and application platform. (LGPL-2.1-only)
* [OpenDJ](https://github.com/OpenIdentityPlatform/OpenDJ) ⭐ 427 | 🐛 8 | 🌐 Java | 📅 2026-02-14 - LDAPv3 compliant directory service, developed for the Java platform, providing a high performance, highly available, and secure store for the identities.
* [ArangoDB](https://github.com/arangodb/arangodb-java-driver) ⭐ 205 | 🐛 13 | 🌐 Java | 📅 2026-02-10 - ArangoDB Java driver.
...
* [iCal4j](https://github.com/ical4j/ical4j) ⭐ 827 | 🐛 159 | 🌐 Java | 📅 2026-01-24 - Parse and build iCalendar [RFC 5545](https://tools.ietf.org/html/rfc5545) data models.
...
* [java-tron](https://github.com/tronprotocol/java-tron) ⭐ 4,029 | 🐛 35 | 🌐 Java | 📅 2026-02-04 Implementation of the Tron Protocol, whic utilizes blockchains to develop decentralized applications.

### Dependency Injection

*Libraries that help to realize the [Inversion of Control](https://en.wikipedia.org/wiki/Inversion_of_control) paradigm.*

* [Guice](https://github.com/google/guice) ⭐ 12,727 | 🐛 359 | 🌐 Java | 📅 2026-02-03 - Lightweight and opinionated framework that completes Dagger.
* [Governator](https://github.com/Netflix/governator) ⭐ 828 | 🐛 11 | 🌐 Java | 📅 2025-12-17 - Extensions and utilities that enhance Google Guice.
* [Feather](https://github.com/zsoltherpai/feather) ⭐ 363 | 🐛 15 | 🌐 Java | 📅 2018-04-18 - Ultra-lightweight, JSR-330-compliant dependency injection library.
...
* [JavaParser](https://github.com/javaparser/javaparser) ⭐ 6,048 | 🐛 448 | 🌐 Java | 📅 2026-02-14 - Parse, modify and generate Java code.
* [Manifold](https://github.com/manifold-systems/manifold) ⭐ 2,709 | 🐛 109 | 🌐 Java | 📅 2026-02-11 - Re-energizes Java with powerful features like type-safe metaprogramming, structural typing and extension methods.
* [HotswapAgent](https://github.com/HotswapProjects/HotswapAgent) ⭐ 2,569 | 🐛 105 | 🌐 Java | 📅 2026-02-14 - Unlimited runtime class and resource redefinition. (GPL-2.0-only)
...
* [Zuul](https://github.com/Netflix/zuul) ⭐ 13,986 | 🐛 10 | 🌐 Java | 📅 2026-02-13 - Gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
* [resilience4j](https://github.com/resilience4j/resilience4j) ⭐ 10,548 | 🐛 277 | 🌐 Java | 📅 2026-02-06 - Functional fault tolerance library.
* [Hazelcast](https://github.com/hazelcast/hazelcast) ⭐ 6,590 | 🐛 1,099 | 🌐 Java | 📅 2026-02-13 - Highly scalable in-memory datagrid with a free open-source version.
...
* [ScaleCube Services](https://github.com/scalecube/scalecube-services) ⭐ 638 | 🐛 16 | 🌐 Java | 📅 2026-01-26 - Embeddable Cluster-Membership library based on SWIM and gossip protocol.
* [OpenIG](https://github.com/OpenIdentityPlatform/OpenIG) ⭐ 87 | 🐛 1 | 🌐 Java | 📅 2026-02-09 - High-performance reverse proxy server with specialized session management and credential replay functionality.
...
* [Seata](https://github.com/seata/seata) ⭐ 25,945 | 🐛 869 | 🌐 Java | 📅 2026-02-10 - Delivers high performance and easy to use distributed transaction services under a microservices architecture.
...
* [Artipie](https://github.com/artipie/artipie) ⭐ 656 | 🐛 86 | 🌐 Java | 📅 2025-09-17 - Binary artifact management toolkit which hosts them on the file system or S3.
* [Getdown](https://github.com/threerings/getdown) ⭐ 532 | 🐛 49 | 🌐 Java | 📅 2026-02-12 - System for deploying Java applications to end-user computers and keeping them up to date. Developed as an alternative to Java Web Start.
...
* [fastexcel](https://github.com/dhatim/fastexcel) ⭐ 859 | 🐛 72 | 🌐 Java | 📅 2026-02-02 - High performance library to read and write large Excel (XLSX) worksheets.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,374 | 🐛 15 | 🌐 Java | 📅 2026-02-14 - Library for technical analysis.
* [Stripe](https://github.com/stripe/stripe-java) ⭐ 951 | 🐛 26 | 🌐 Java | 📅 2026-02-13 - Integration with the Stripe API.
...
* [Philadelphia](https://github.com/paritytrading/philadelphia) ⭐ 340 | 🐛 2 | 🌐 Java | 📅 2026-02-14 - Low-latency financial information exchange.
...
* [Java Path Finder (JPF)](https://github.com/javapathfinder/jpf-core) ⭐ 602 | 🐛 69 | 🌐 Java | 📅 2025-12-16 - JVM formal verification tool containing a model checker and more. Created by NASA.
...
* [jOOλ](https://github.com/jOOQ/jOOL) ⭐ 2,121 | 🐛 45 | 🌐 Java | 📅 2024-08-01 - Extension to Java 8 that aims to fix gaps in lambda by providing numerous missing types and a rich set of sequential Stream API additions.
* [Cyclops](https://github.com/aol/cyclops) ⭐ 1,331 | 🐛 29 | 🌐 Java | 📅 2023-03-21 - Monad and stream utilities, comprehensions, pattern matching, functional extensions for all JDK collections, future streams, trampolines and much more.
...
* [Packrat](https://github.com/jhspetersson/packrat) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-02-08 - Gatherers library for Java Stream API. Gatherers can enhance streams with custom intermediate operations.
...
* [vulkan4j](https://github.com/chuigda/vulkan4j) ⭐ 78 | 🐛 18 | 🌐 Kotlin | 📅 2025-07-28 - Vulkan, OpenGL ES2 and GLFW Memory Allocator bindings.
...
* [GraphHopper](https://github.com/graphhopper/graphhopper) ⭐ 6,269 | 🐛 256 | 🌐 Java | 📅 2026-02-14 - Road-routing engine. Used as a Java library or standalone web service.
* [Mapsforge](https://github.com/mapsforge/mapsforge) ⭐ 1,339 | 🐛 2 | 🌐 Java | 📅 2026-02-09 - Map rendering based on OpenStreetMap data. (LGPL-3.0-only)
...
* [ArcGIS Maps SDK for Java ![c]](https://github.com/Esri/arcgis-maps-sdk-java-samples/) ⭐ 126 | 🐛 0 | 🌐 Java | 📅 2025-09-19 - JavaFX library for adding mapping and GIS functionality to desktop apps.
...
* [SnapKit](https://github.com/reportmill/SnapKit) ⭐ 314 | 🐛 2 | 🌐 Java | 📅 2026-02-13 - Modern Java UI library for both desktop and web.
* [Sierra](https://github.com/HTTP-RPC/Sierra) ⭐ 138 | 🐛 0 | 🌐 Java | 📅 2026-02-10 - Lightwieght declarative DSL for rapid development of Swing applications.
...
* [JCTools](https://github.com/JCTools/JCTools) ⭐ 3,805 | 🐛 54 | 🌐 Java | 📅 2026-02-08 - Concurrency tools currently missing from the JDK.
* [Agrona](https://github.com/real-logic/Agrona) ⭐ 3,154 | 🐛 2 | 🌐 Java | 📅 2026-02-11 - Data structures and utility methods that are common in high-performance applications.
* [Eclipse Collections](https://github.com/eclipse/eclipse-collections) ⭐ 2,611 | 🐛 176 | 🌐 Java | 📅 2026-02-13 - Collections framework inspired by Smalltalk.
...
* [Feign](https://github.com/OpenFeign/feign) ⭐ 9,791 | 🐛 235 | 🌐 Java | 📅 2026-02-13 - HTTP client binder inspired by Retrofit, JAXRS-2.0, and WebSocket.
* [Async Http Client](https://github.com/AsyncHttpClient/async-http-client) ⭐ 6,406 | 🐛 106 | 🌐 Java | 📅 2026-02-11 - Asynchronous HTTP and WebSocket client library.
...
* [unirest-java](https://github.com/Kong/unirest-java) ⭐ 2,705 | 🐛 3 | 🌐 Java | 📅 2026-02-12 - Simplified, lightweight HTTP client library.
* [Google HTTP Client](https://github.com/googleapis/google-http-java-client) ⭐ 1,433 | 🐛 76 | 🌐 Java | 📅 2026-02-11 - Pluggable HTTP transport abstraction with support for java.net.HttpURLConnection, Apache HTTP Client, Android, Google App Engine, XML, Gson, Jackson and Protobuf.
* [Riptide](https://github.com/zalando/riptide) ⭐ 331 | 🐛 19 | 🌐 Java | 📅 2026-02-13 - Client-side response routing for Spring's RestTemplate.
* [methanol](https://github.com/mizosoft/methanol) ⭐ 289 | 🐛 17 | 🌐 Java | 📅 2026-02-13 - HTTP client extensions library.
...
* [Spring HATEOAS](https://github.com/spring-projects/spring-hateoas) ⭐ 1,079 | 🐛 279 | 🌐 Java | 📅 2026-01-26 - Standalone and Spring support for building hypermedia-based APIs using HAL, HAL FORMS, Collection+JSON, ALPS and UBER.
* [JSON-LD](https://github.com/jsonld-java/jsonld-java) ⭐ 387 | 🐛 54 | 🌐 Java | 📅 2024-01-10 - JSON-LD implementation.
...
* [ZXing](https://github.com/zxing/zxing) ⭐ 33,854 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - Multi-format 1D/2D barcode image processing library.
* [Thumbnailator](https://github.com/coobird/thumbnailator) ⭐ 5,387 | 🐛 53 | 🌐 Java | 📅 2026-01-08 - High-quality thumbnail generation library.
* [TwelveMonkeys](https://github.com/haraldk/TwelveMonkeys) ⭐ 2,092 | 🐛 62 | 🌐 Java | 📅 2026-02-13 - Collection of plugins that extend the number of supported image file formats.
* [Tess4J](https://github.com/nguyenq/tess4j) ⭐ 1,730 | 🐛 26 | 🌐 Java | 📅 2026-01-17 - JNA wrapper for Tesseract OCR API.
* [Imgscalr](https://github.com/rkalla/imgscalr) ⭐ 1,246 | 🐛 43 | 🌐 Java | 📅 2023-10-21 - Simple, efficient and hardware-accelerated image-scaling library implemented in pure Java 2D.
* [image-comparison](https://github.com/romankh3/image-comparison) ⭐ 389 | 🐛 34 | 🌐 Java | 📅 2025-06-11 - Library that compares 2 images with the same sizes and shows the differences visually by drawing rectangles. Some parts of the image can be excluded from the comparison.
* [vips-ffm](https://github.com/lopcode/vips-ffm) ⭐ 106 | 🐛 8 | 🌐 Java | 📅 2026-02-09 - Comprehensive bindings for libvips, using Java's "Foreign Function & Memory" API.
...
* [Reflections](https://github.com/ronmamo/reflections) ⭐ 4,776 | 🐛 122 | 🌐 Java | 📅 2024-06-17 - Reflections scans your classpath, indexes the metadata, allows you to query it on runtime and may save and collect that information for many modules within your project.
* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,956 | 🐛 44 | 🌐 Java | 📅 2025-10-10 - ClassGraph (formerly FastClasspathScanner) is an uber-fast, ultra-lightweight, parallelized classpath scanner and module scanner for Java, Scala, Kotlin and other JVM languages.
* [jOOR](https://github.com/jOOQ/jOOR) ⭐ 2,831 | 🐛 25 | 🌐 Java | 📅 2025-01-06 - jOOR stands for jOOR Object Oriented Reflection. It is a simple wrapper for the java.lang.reflect package.
* [ReflectASM](https://github.com/EsotericSoftware/reflectasm) ⭐ 1,546 | 🐛 17 | 🌐 Java | 📅 2025-06-05 - ReflectASM is a very small Java library that provides high performance reflection by using code generation.
...
* [Quartz](https://github.com/quartz-scheduler/quartz) ⭐ 6,688 | 🐛 71 | 🌐 Java | 📅 2026-01-30 - Feature-rich, open source job scheduling library that can be integrated within virtually any Java application.
* [shedlock](https://github.com/lukas-krecan/ShedLock) ⭐ 4,094 | 🐛 22 | 🌐 Java | 📅 2026-02-13 - Makes sure that your scheduled tasks are executed at most once at the same time. If a task is being executed on one node, it acquires a lock which prevents execution of the same task from another node or thread.
* [JobRunr](https://github.com/jobrunr/jobrunr) ⭐ 2,868 | 🐛 4 | 🌐 Java | 📅 2026-02-13 - Job scheduling library which utilizes lambdas for fire-and-forget, delayed and recurring jobs. Guarantees execution by single scheduler instance using optimistic locking. Has features for persistence, minimal dependencies and is embeddable.
* [db-scheduler](https://github.com/kagkarlsson/db-scheduler) ⭐ 1,500 | 🐛 92 | 🌐 Java | 📅 2026-02-12 - Persistent and cluster-friendly scheduler.
* [easy-batch](https://github.com/j-easy/easy-batch) ⭐ 629 | 🐛 16 | 🌐 Java | 📅 2023-03-20 - Set up batch jobs with simple processing pipelines. Records are read in sequence from a data source, processed in pipeline and written in batches to a data sink.
* [Sundial](https://github.com/knowm/Sundial) ⭐ 276 | 🐛 13 | 🌐 Java | 📅 2024-07-15 - Lightweight framework to simply define jobs, define triggers and start the scheduler.
* [Wisp](https://github.com/Coreoz/Wisp) ⭐ 142 | 🐛 7 | 🌐 Java | 📅 2026-01-26 - Simple library with minimal footprint and straightforward API.
...
* [Gson](https://github.com/google/gson) ⭐ 24,343 | 🐛 329 | 🌐 Java | 📅 2026-02-13 - Serializes objects to JSON and vice versa. Good performance with on-the-fly usage.
* [Moshi](https://github.com/square/moshi) ⭐ 10,108 | 🐛 97 | 🌐 Kotlin | 📅 2026-02-05 - Modern JSON library, less opinionated and uses built-in types like List and Map.
* [Jackson](https://github.com/FasterXML/jackson) ⭐ 9,666 | 🐛 1 | 📅 2026-02-13 - Similar to GSON, but offers performance gains if you need to instantiate the library more often.
* [JsonPath](https://github.com/json-path/JsonPath) ⭐ 9,390 | 🐛 429 | 🌐 Java | 📅 2026-02-04 - Extract data from JSON using XPATH-like syntax.
* [LoganSquare](https://github.com/bluelinelabs/LoganSquare) ⭐ 3,190 | 🐛 83 | 🌐 Java | 📅 2021-12-07 - JSON parsing and serializing library based on Jackson's streaming API. Outperforms GSON & Jackson's library.
* [Jolt](https://github.com/bazaarvoice/jolt) ⭐ 1,662 | 🐛 409 | 🌐 Java | 📅 2025-07-12 - JSON to JSON transformation tool.
* [DSL-JSON](https://github.com/ngs-doo/dsl-json) ⭐ 1,060 | 🐛 42 | 🌐 Java | 📅 2024-12-03 - JSON library with advanced compile time databinding.
...
* [JSON-io](https://github.com/jdereg/json-io) ⭐ 370 | 🐛 2 | 🌐 Java | 📅 2026-02-11 - Convert Java to JSON/TOON and back. Supports complex object graphs, cyclic references, and TOON format for 40-50% LLM token savings.
* [JsonSurfer](https://github.com/jsurfer/JsonSurfer) ⭐ 315 | 🐛 16 | 🌐 Java | 📅 2024-06-03 - Streaming JsonPath processor dedicated to processing big and complicated JSON data.
...
* [Yasson](https://github.com/eclipse-ee4j/yasson) ⭐ 214 | 🐛 136 | 🌐 Java | 📅 2025-07-13 - Binding layer between classes and JSON documents similar to JAXB.
...
* [Graal](https://github.com/oracle/graal) ⭐ 21,468 | 🐛 810 | 🌐 Java | 📅 2026-02-14 - Polyglot embeddable JVM. (GPL-2.0-only WITH Classpath-exception-2.0)
* [Dragonwell8](https://github.com/alibaba/dragonwell8) ⭐ 4,317 | 🐛 169 | 🌐 Java | 📅 2026-02-09 - Downstream version of OpenJDK optimized for online e-commerce, financial, logistics applications.
* [OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,502 | 🐛 3,022 | 🌐 Java | 📅 2026-02-14 - High performance, enterprise-calibre, flexibly licensed, openly-governed cross-platform JVM extending and augmenting the runtime technology components from the Eclipse OMR and OpenJDK project.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,822 | 🐛 552 | 🌐 Java | 📅 2026-02-15 - VM with non-blocking, concurrent GC for iOS. (GPL-2.0-only WITH Classpath-exception-2.0)
...
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,015 | 🐛 36 | 🌐 Java | 📅 2026-02-13 - Extensible, open-source library for HTTP request and response logging.
...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,338 | 🐛 6 | 🌐 Java | 📅 2026-02-15 - Statistical Machine Intelligence and Learning Engine provides a set of machine learning algorithms and a visualization library.
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,957 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - CLI tool to transpile models into native code.
...
* [Siddhi](https://github.com/siddhi-io/siddhi) ⭐ 1,578 | 🐛 124 | 🌐 Java | 📅 2025-08-08 - Cloud native streaming and complex event processing engine.
* [JSAT](https://github.com/EdwardRaff/JSAT) ⭐ 798 | 🐛 15 | 🌐 Java | 📅 2022-12-16 - Algorithms for pre-processing, classification, regression, and clustering with support for multi-threaded execution. (GPL-3.0-only)
* [Neureka](https://github.com/Gleethos/neureka) ⭐ 86 | 🐛 2 | 🌐 Java | 📅 2026-01-25 - A lightweight, platform independent, OpenCL accelerated nd-array/tensor library.
...
* [AutoMQ](https://github.com/AutoMQ/automq-for-kafka) ⭐ 9,503 | 🐛 84 | 🌐 Java | 📅 2026-02-13 - AutoMQ is a cloud-native, serverless reinvented Kafka that is easily scalable, manage-less and cost-effective.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,446 | 🐛 16 | 🌐 Java | 📅 2026-02-07 - Efficient, reliable, unicast and multicast message transport.
* [JeroMQ](https://github.com/zeromq/jeromq) ⭐ 2,441 | 🐛 101 | 🌐 Java | 📅 2025-11-30 - Implementation of ZeroMQ.
* [Smack](https://github.com/igniterealtime/Smack) ⭐ 2,417 | 🐛 33 | 🌐 Java | 📅 2025-12-02 - Cross-platform XMPP client library.
* [RabbitMQ Java client](https://github.com/rabbitmq/rabbitmq-java-client) ⭐ 1,299 | 🐛 21 | 🌐 Java | 📅 2026-02-10 - RabbitMQ client.
* [Nakadi](https://github.com/zalando/nakadi) ⚠️ Archived - Provides a RESTful API on top of Kafka.
* [NATS client](https://github.com/nats-io/nats.java) ⭐ 647 | 🐛 6 | 🌐 Java | 📅 2026-02-13 - NATS client.
...
* [Sentinel](https://github.com/alibaba/Sentinel) ⭐ 23,067 | 🐛 839 | 🌐 Java | 📅 2026-01-26 - Flow control component enabling reliability, resilience and monitoring for microservices.
...
* [Armeria](https://github.com/line/armeria) ⭐ 5,071 | 🐛 704 | 🌐 Java | 📅 2026-02-14 - Asynchronous RPC/REST client/server library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC.
* [OpenAI-Java](https://github.com/TheoKanning/openai-java) ⚠️ Archived - Java libraries for using OpenAI's GPT-3 API.
* [JDA](https://github.com/DV8FromTheWorld/JDA) ⭐ 4,628 | 🐛 59 | 🌐 Java | 📅 2026-02-14 - Wrapping of the Discord REST API and its WebSocket events.
* [kubernetes-client](https://github.com/fabric8io/kubernetes-client) ⭐ 3,619 | 🐛 103 | 🌐 Java | 📅 2026-02-13 - Client provides access to the full Kubernetes & OpenShift REST APIs via a fluent DSL.
...
* [Design Patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 93,740 | 🐛 213 | 🌐 Java | 📅 2026-02-10 - Implementation and explanation of the most common design patterns.
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,264 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - No-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes. (No explicit license)
* [Modern Java - A Guide to Java 8](https://github.com/winterbe/java8-tutorial) ⭐ 16,783 | 🐛 19 | 🌐 Java | 📅 2023-08-11 - Popular Java 8 guide.
* [J2ObjC](https://github.com/google/j2objc) ⭐ 6,038 | 🐛 99 | 🌐 Java | 📅 2026-02-11 - Java-to-Objective-C translator for porting Android libraries to iOS.
...
* [Svix](https://github.com/svix/svix-webhooks/tree/main/java) ⭐ 3,106 | 🐛 61 | 🌐 Rust | 📅 2026-02-14 - Library for the Svix API to send webhooks and verify signatures.
* [Jimfs](https://github.com/google/jimfs) ⭐ 2,529 | 🐛 37 | 🌐 Java | 📅 2026-02-09 - In-memory file system.
...
* [LittleProxy](https://github.com/adamfisk/LittleProxy) ⭐ 2,116 | 🐛 111 | 🌐 PHP | 📅 2024-07-08 - High performance HTTP proxy atop Netty's event-based networking library.
* [CQEngine](https://github.com/npgall/cqengine) ⭐ 1,767 | 🐛 81 | 🌐 Java | 📅 2023-12-27 - Ultra-fast, SQL-like queries on Java collections.
...
* [jsweet](https://github.com/cincheo/jsweet) ⭐ 1,490 | 🐛 164 | 🌐 Java | 📅 2023-12-16 - Source transpiler to TypeScript/JavaScript.
* [FF4J](https://github.com/ff4j/ff4j) ⭐ 1,444 | 🐛 38 | 🌐 Java | 📅 2026-02-13 - Feature Flags for Java.
* [Simple Java Mail](https://github.com/bbottema/simple-java-mail) ⭐ 1,287 | 🐛 39 | 🌐 Java | 📅 2025-06-02 - Mailing with a clean and fluent API.
* [JBot](https://github.com/rampatra/jbot) ⭐ 1,205 | 🐛 78 | 🌐 Java | 📅 2025-10-08 - Framework for building chatbots. (GPL-3.0-only)
* [Polyglot for Maven](https://github.com/takari/polyglot-maven) ⭐ 918 | 🐛 46 | 🌐 Java | 📅 2025-11-20 - Extensions for Maven 3.3.1+ that allows writing the POM model in dialects other than XML.
* [TypeTools](https://github.com/jhalterman/typetools) ⭐ 630 | 🐛 24 | 🌐 Java | 📅 2023-04-12 - Tools for resolving generic types.
* [Membrane Service Proxy](https://github.com/membrane/service-proxy) ⭐ 560 | 🐛 22 | 🌐 Java | 📅 2026-02-13 - Open-source, reverse-proxy framework.
...
* [MinimalFTP](https://github.com/Guichaguri/MinimalFTP) ⭐ 186 | 🐛 1 | 🌐 Java | 📅 2025-06-15 - Lightweight, small and customizable FTP server.
* [JEmoji](https://github.com/felldo/JEmoji) ⭐ 104 | 🐛 3 | 🌐 Java | 📅 2026-02-09 - An auto-generated emoji library that provides type-safe direct access to emojis and alias support for Discord, Slack, GitHub and many more features.
...
* [Pinpoint](https://github.com/naver/pinpoint) ⭐ 13,806 | 🐛 512 | 🌐 Java | 📅 2026-02-13 - Open-source APM tool.
* [Dropwizard Metrics](https://github.com/dropwizard/metrics) ⭐ 7,855 | 🐛 17 | 🌐 Java | 📅 2026-02-14 - Expose metrics via JMX or HTTP and send them to a database.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,081 | 🐛 314 | 🌐 Java | 📅 2026-02-13 - Real-time monitoring system with custom-monitor and agentless.
...
* [Micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,807 | 🐛 284 | 🌐 Java | 📅 2026-02-13 - Vendor-neutral metrics/observability facade for the most popular metrics/observability libraries.
* [JavaMelody](https://github.com/javamelody/javamelody) ⭐ 3,034 | 🐛 46 | 🌐 Java | 📅 2026-02-02 - Performance monitoring and profiling.
* [OpenTelemetry](https://github.com/open-telemetry/opentelemetry-java) ⭐ 2,356 | 🐛 173 | 🌐 Java | 📅 2026-02-13 - Instrument, generate, collect, and export telemetry data to help you analyze your software’s performance and behavior.
* [Prometheus](https://github.com/prometheus/client_java) ⭐ 2,264 | 🐛 128 | 🌐 Java | 📅 2026-02-14 - Provides a multi-dimensional data model, DSL, autonomous server nodes and much more.
...
* [Sentry ![c]](https://github.com/getsentry/sentry-java) ⭐ 1,297 | 🐛 222 | 🌐 Kotlin | 📅 2026-02-13 - Integration with [Sentry](https://github.com/getsentry/sentry) ⭐ 43,149 | 🐛 2,053 | 🌐 Python | 📅 2026-02-14, an application error tracking and performance analysis platform.
* [Datadog ![c]](https://github.com/DataDog/dd-trace-java) ⭐ 691 | 🐛 309 | 🌐 Java | 📅 2026-02-14 - Modern monitoring & analytics.
...
* [Micrometer Tracing](https://github.com/micrometer-metrics/tracing) ⭐ 290 | 🐛 25 | 🌐 Java | 📅 2026-02-13 - Vendor-neutral distributed tracing facade for the most popular tracer libraries.
...
* [SPM ![c]](https://github.com/sematext/sematext-agent-java) ⭐ 24 | 🐛 17 | 🌐 Java | 📅 2026-02-11 - Performance monitor with distributing transaction tracing for JVM apps.
* [Apitally](https://github.com/apitally/apitally-java) ⭐ 5 | 🐛 2 | 🌐 Java | 📅 2026-02-14 - Simple, privacy-focused API monitoring, analytics and request logging for Spring Boot apps.
...
* [JNA](https://github.com/java-native-access/jna) ⭐ 8,893 | 🐛 119 | 🌐 Java | 📅 2026-01-01 - Work with native libraries without writing JNI. Also provides interfaces to common system libraries.
* [JavaCPP](https://github.com/bytedeco/javacpp) ⭐ 4,688 | 🐛 110 | 🌐 Java | 📅 2025-12-09 - Provides efficient and easy access to native C++.
* [JNR](https://github.com/jnr/jnr-ffi) ⭐ 1,317 | 🐛 97 | 🌐 Java | 📅 2025-10-24 - Work with native libraries without writing JNI. Also provides interfaces to common system libraries. Same goals as JNA, but faster, and serves as the basis for the upcoming [Project Panama](http://openjdk.java.net/projects/panama).
...
* [CogCompNLP](https://github.com/CogComp/cogcomp-nlp) ⭐ 481 | 🐛 200 | 🌐 Java | 📅 2023-07-07 - Provides common annotators for plain text input. (Research and Academic Use License)
...
* [Dubbo](https://github.com/apache/dubbo) ⭐ 41,728 | 🐛 914 | 🌐 Java | 📅 2026-02-10 - High-performance RPC framework.
* [gRPC-java](https://github.com/grpc/grpc-java) ⭐ 11,980 | 🐛 502 | 🌐 Java | 📅 2026-02-12 - RPC framework based on protobuf and HTTP/2.
...
* [ServiceTalk](https://github.com/apple/servicetalk) ⭐ 1,019 | 🐛 76 | 🌐 Java | 📅 2026-02-09 - Framework built on Netty with APIs tailored to specific protocols and support for multiple programming paradigms.
...
* [TLS Channel](https://github.com/marianobarrios/tls-channel) ⭐ 207 | 🐛 3 | 🌐 Java | 📅 2026-02-14 - Implements a ByteChannel interface over SSLEngine, enabling easy-to-use (socket-like) TLS.
...
* [MyBatis](https://github.com/mybatis/mybatis-3) ⭐ 20,378 | 🐛 199 | 🌐 Java | 📅 2026-02-14 - Couples objects with stored procedures or SQL statements.
* [MyBatis-Plus](https://github.com/baomidou/mybatis-plus) ⭐ 17,300 | 🐛 107 | 🌐 Java | 📅 2026-02-07 - A powerful enhanced toolkit of MyBatis for simplifying development.
* [ObjectiveSql](https://github.com/braisdom/ObjectiveSql) ⭐ 1,257 | 🐛 18 | 🌐 Java | 📅 2024-05-06 - ActiveRecord ORM for rapid development and convention over configuration.
* [Doma](https://github.com/domaframework/doma) ⭐ 493 | 🐛 3 | 🌐 Java | 📅 2026-02-15 - Database access framework that verifies and generates source code at compile time using annotation processing as well as native SQL templates called two-way SQL.
* [SimpleFlatMapper](https://github.com/arnaudroger/SimpleFlatMapper) ⭐ 456 | 🐛 158 | 🌐 Java | 📅 2025-09-21 - Simple database and CSV mapper.
...
* [Pathetic](https://github.com/bsommerfeld/pathetic) ⭐ 247 | 🐛 0 | 🌐 Java | 📅 2026-02-11 - A highly configurable 3D A\* pathfinding library that uses specific optimizations for high performance.

### PDF

*Tools to help with PDF files.*

* [OpenPDF](https://github.com/LibrePDF/OpenPDF) ⭐ 4,182 | 🐛 162 | 🌐 Java | 📅 2025-10-27 - Open-source iText fork. (LGPL-3.0-only & MPL-2.0)
* [flyingsaucer](https://github.com/flyingsaucerproject/flyingsaucer) ⭐ 2,198 | 🐛 39 | 🌐 Java | 📅 2026-02-13 - XML/XHTML and CSS 2.1 renderer. (LGPL-2.1-or-later)
* [Tabula](https://github.com/tabulapdf/tabula-java) ⭐ 2,009 | 🐛 194 | 🌐 Java | 📅 2025-03-19 - Extracts tables from PDF files.
* [DynamicReports](https://github.com/dynamicreports/dynamicreports) ⭐ 240 | 🐛 28 | 🌐 Java | 📅 2026-02-11 - Simplifies JasperReports. (LGPL-3.0-only)
* [Open HTML to PDF](https://github.com/openhtmltopdf/openhtmltopdf) ⭐ 231 | 🐛 60 | 🌐 Java | 📅 2026-01-21 - Properly supports modern PDF standards based on flyingsaucer and Apache PDFBox.
...
* [JITWatch](https://github.com/AdoptOpenJDK/jitwatch) ⭐ 3,268 | 🐛 17 | 🌐 Java | 📅 2025-12-28 - Analyze the JIT compiler optimisations made by the HotSpot JVM.
* [honest-profiler](https://github.com/jvm-profiling-tools/honest-profiler) ⭐ 1,253 | 🐛 64 | 🌐 Java | 📅 2023-12-05 - Low-overhead, bias-free sampling profiler.
...
* [Light-4J](https://github.com/networknt/light-4j/) ⭐ 3,680 | 🐛 14 | 🌐 Java | 📅 2026-02-14 - Fast, lightweight and productive microservices framework with built-in [security](https://github.com/networknt/light-oauth2/) ⚠️ Archived.
* [Orienteer](https://github.com/OrienteerBAP/Orienteer/) ⭐ 257 | 🐛 171 | 🌐 Java | 📅 2024-02-08 - Open-source business application platform for rapid configuration/development of CRM, ERP, LMS and other applications.
...
* [zt-exec](https://github.com/zeroturnaround/zt-exec) ⭐ 912 | 🐛 11 | 🌐 Java | 📅 2025-07-12 - Provides a unified API to Apache Commons Exec and ProcessBuilder.
* [zt-process-killer](https://github.com/zeroturnaround/zt-process-killer) ⭐ 137 | 🐛 9 | 🌐 Java | 📅 2023-12-05 - Stops processes started from Java or the system processes via PID.
* [ch.vorburger.exec](https://github.com/vorburger/ch.vorburger.exec) ⭐ 39 | 🐛 15 | 🌐 Java | 📅 2026-02-05 - Convenient API around Apache Commons Exec.

### Reactive libraries

*Libraries for developing reactive applications.*

* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,528 | 🐛 20 | 🌐 Java | 📅 2026-02-06 - Allows for composing asynchronous and event-based programs using observable sequences.
* [Reactive Streams](https://github.com/reactive-streams/reactive-streams-jvm) ⭐ 4,866 | 🐛 34 | 🌐 Java | 📅 2024-03-13 - Provides a standard for asynchronous stream processing with non-blocking backpressure.
* [Reactor](https://github.com/reactor/reactor) ⭐ 3,688 | 🐛 9 | 📅 2026-02-10 - A framework for building non-blocking applications on the JVM, providing support for reactive programming.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,816 | 🐛 5,582 | 🌐 Java | 📅 2026-02-14 - Allows generation of API client libraries, SDKs, server stubs, documentation and configuration automatically given an OpenAPI Spec.
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,596 | 🐛 34 | 🌐 Java | 📅 2026-02-14 - Opinionated framework for setting up modern web applications with Jetty, Jackson, Jersey and Metrics.
* [springdoc-openapi](https://github.com/springdoc/springdoc-openapi) ⭐ 3,669 | 🐛 22 | 🌐 Java | 📅 2026-02-10 - Automates the generation of API documentation using Spring Boot projects.
* [rest.li](https://github.com/linkedin/rest.li) ⭐ 2,533 | 🐛 109 | 🌐 Java | 📅 2026-02-13 - Framework for building robust, scalable RESTful architectures using typesafe bindings and asynchronous, non-blocking IO with an end-to-end developer workflow that promotes clean practices, uniform interface design and consistent data modeling.
...
* [Restlet Framework](https://github.com/restlet/restlet-framework-java) ⭐ 662 | 🐛 555 | 🌐 Java | 📅 2026-02-13 - Pioneering framework with powerful routing and filtering capabilities, and a unified client and server API.
...
* [Tablesaw](https://github.com/jtablesaw/tablesaw) ⭐ 3,734 | 🐛 141 | 🌐 Java | 📅 2025-07-12 - Includes a data-frame, an embedded column store, and hundreds of methods to transform, summarize, or filter data.
* [JGraphT](https://github.com/jgrapht/jgrapht) ⭐ 2,758 | 🐛 154 | 🌐 Java | 📅 2026-02-10 - Graph library that provides mathematical graph-theory objects and algorithms.
* [XChart](https://github.com/knowm/XChart) ⭐ 1,576 | 🐛 158 | 🌐 Java | 📅 2025-10-27 - Light-weight library for plotting data. Many customizable chart types are available.
...
* [Erdos](https://github.com/Erdos-Graph-Framework/Erdos) ⭐ 126 | 🐛 2 | 🌐 Java | 📅 2023-08-27 - Modular, light and easy graph framework for theoretic algorithms.
...
* [Mines Java Toolkit](https://github.com/MinesJTK/jtk) ⭐ 83 | 🐛 5 | 🌐 Java | 📅 2021-03-25 - Library for geophysical scientific computation, visualization and digital signal analysis.
...
* [jjwt](https://github.com/jwtk/jjwt) ⭐ 11,028 | 🐛 48 | 🌐 Java | 📅 2025-10-17 - JSON web token for Java and Android.
...
* [OpenAM](https://github.com/OpenIdentityPlatform/OpenAM) ⭐ 865 | 🐛 3 | 🌐 Java | 📅 2026-02-14 - Access management solution that includes authentication, SSO, authorization, federation, entitlements and web services security.
* [Ayza](https://github.com/Hakky54/ayza) ⭐ 570 | 🐛 0 | 🌐 Java | 📅 2026-02-12 - High-level SSL configuration builder for configuring HTTP clients and servers with SSL/TLS.
* [Password4j](https://github.com/Password4j/password4j) ⭐ 408 | 🐛 9 | 🌐 Java | 📅 2025-09-06 - User-friendly cryptographic library that supports Argon2, Bcrypt, Scrypt, PBKDF2 and various other cryptographic hash functions.
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 25,545 | 🐛 142 | 🌐 C++ | 📅 2026-02-12 - Memory-efficient serialization library that can access serialized data without unpacking and parsing it.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,487 | 🐛 35 | 🌐 HTML | 📅 2026-02-09 - Fast and efficient object graph serialization framework.
* [Fury](https://github.com/alipay/fury) ⭐ 4,210 | 🐛 158 | 🌐 Java | 📅 2026-02-14 - Blazing fast object graph serialization framework powered by JIT and zero-copy.
...
* [MessagePack](https://github.com/msgpack/msgpack-java) ⭐ 1,464 | 🐛 73 | 🌐 Java | 📅 2026-01-05 - Efficient binary serialization format.
...
* [jte](https://github.com/casid/jte) ⭐ 1,080 | 🐛 50 | 🌐 Java | 📅 2026-02-10 - Compiles to classes, and uses an easy syntax, several features to make development easier and provides fast execution and a small footprint.
...
* [Rocker](https://github.com/fizzed/rocker) ⭐ 783 | 🐛 48 | 🌐 Java | 📅 2026-01-21 - Optimized, memory efficient and speedy template engine producing statically typed, plain objects.
* [Jade4J](https://github.com/neuland/jade4j) ⭐ 707 | 🐛 9 | 🌐 Java | 📅 2022-05-20 - Implementation of Pug (formerly known as Jade).
...
* [Karate](https://github.com/intuit/karate) ⭐ 8,784 | 🐛 70 | 🌐 Java | 📅 2026-02-05 - DSL that combines API test-automation, mocks and performance-testing making testing REST/HTTP services easy.
* [REST Assured](https://github.com/rest-assured/rest-assured) ⭐ 7,109 | 🐛 586 | 🌐 Java | 📅 2026-02-04 - DSL for easy testing of REST/HTTP services.
* [Awaitility](https://github.com/awaitility/awaitility) ⭐ 3,987 | 🐛 85 | 🌐 Java | 📅 2025-02-26 - DSL for synchronizing asynchronous operations.
...
* [WebTau](https://github.com/testingisdocumenting/webtau) ⭐ 380 | 🐛 6 | 🌐 Java | 📅 2026-02-12 - Test across REST-API, Graph QL, Browser, Database, CLI and Business Logic with consistent set of matchers and concepts.
* [Hoverfly Java](https://github.com/SpectoLabs/hoverfly-java) ⭐ 173 | 🐛 16 | 🌐 Java | 📅 2025-12-20 - Native bindings for Hoverfly, a proxy which allows you to simulate HTTP services.
...
* [Cucumber](https://github.com/cucumber/cucumber-jvm) ⭐ 2,791 | 🐛 62 | 🌐 Java | 📅 2026-02-14 - Provides a way to describe features in a plain language which customers can understand.
* [Serenity BDD](https://github.com/serenity-bdd/serenity-core) ⭐ 748 | 🐛 437 | 🌐 HTML | 📅 2026-02-03 - Automated Acceptance testing and reporting library that works with Cucumber, JBehave and JUnit to make it easier to write high quality executable specifications.
...
* [Java Faker](https://github.com/DiUS/java-faker) ⭐ 4,927 | 🐛 226 | 🌐 Java | 📅 2024-06-12 - Port of Ruby's fake data generator.
* [Datafaker](https://github.com/datafaker-net/datafaker) ⭐ 1,736 | 🐛 8 | 🌐 Java | 📅 2026-02-12 - Modern fake data generator forked from Java Faker.
* [Instancio](https://github.com/instancio/instancio) ⭐ 1,106 | 🐛 6 | 🌐 Java | 📅 2026-02-15 - Automates data setup in unit tests by generating fully-populated, reproducible objects. Includes JUnit 5 extension.
* [jFairy](https://github.com/Devskiller/jfairy) ⭐ 745 | 🐛 32 | 🌐 Java | 📅 2024-03-18 - Fake data generator.
* [Mockneat](https://github.com/nomemory/mockneat) ⭐ 537 | 🐛 8 | 🌐 Java | 📅 2023-03-27 - Another fake data generator.
* [Fixture Factory](https://github.com/six2six/fixture-factory) ⭐ 445 | 🐛 34 | 🌐 Java | 📅 2023-04-14 - Generates fake objects from a template.
...
* [Randomized Testing](https://github.com/randomizedtesting/randomizedtesting) ⭐ 180 | 🐛 21 | 🌐 Java | 📅 2026-02-12 - JUnit test runner and plugins for running JUnit tests with pseudo-randomness.
...
* [Pact JVM](https://github.com/DiUS/pact-jvm) ⭐ 1,124 | 🐛 382 | 🌐 Kotlin | 📅 2026-02-05 - Consumer-driven contract testing.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 981 | 🐛 18 | 🌐 Java | 📅 2026-02-13 - Library that simplifies JSON comparison in tests.
...
* [Testcontainers](https://github.com/testcontainers/testcontainers-java) ⭐ 8,584 | 🐛 627 | 🌐 Java | 📅 2026-02-03 - Provides throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
...
* [Selfie](https://github.com/diffplug/selfie) ⭐ 89 | 🐛 50 | 🌐 Kotlin | 📅 2026-02-05 - Snapshot testing (inline and on disk).
...
* [Mockito](https://github.com/mockito/mockito) ⭐ 15,426 | 🐛 481 | 🌐 Java | 📅 2026-02-13 - Mocking framework that lets you write tests with a clean and simple API.
* [Moco](https://github.com/dreamhead/moco) ⭐ 4,432 | 🐛 144 | 🌐 Java | 📅 2026-02-04 - Concise web services for stubs and mocks.
* [PowerMock](https://github.com/powermock/powermock) ⭐ 4,187 | 🐛 462 | 🌐 Java | 📅 2024-01-03 - Mocks static methods, constructors, final classes and methods, private methods, and removal of static initializers.
* [EasyMock](https://github.com/easymock/easymock) ⭐ 830 | 🐛 61 | 🌐 HTML | 📅 2026-02-10 - EasyMock is a Java library that provides an easy way to use Mock Objects in unit testing.
...
* [Guava](https://github.com/google/guava) ⭐ 51,473 | 🐛 720 | 🌐 Java | 📅 2026-02-13 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and more.
* [Arthas](https://github.com/alibaba/arthas) ⭐ 37,092 | 🐛 461 | 🌐 Java | 📅 2026-02-03 - Allows to troubleshoot production issues for applications without modifying code or restarting servers.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,361 | 🐛 545 | 🌐 Java | 📅 2026-02-14 - Cross-platform for visualizing and manipulating large graph networks. (GPL-3.0-only)
* [bucket4j](https://github.com/vladimir-bukhtoyarov/bucket4j) ⭐ 2,693 | 🐛 23 | 🌐 Java | 📅 2026-02-04 - Rate limiting library based on token-bucket algorithm.
* [JavaVerbalExpressions](https://github.com/VerbalExpressions/JavaVerbalExpressions) ⭐ 2,628 | 🐛 15 | 🌐 Java | 📅 2026-02-05 - Library that helps with constructing difficult regular expressions.
...
* [Dex](https://github.com/PatMartin/Dex) ⭐ 1,319 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-12 - Java/JavaFX tool capable of powerful ETL and data visualization.
* [minio-java](https://github.com/minio/minio-java) ⭐ 1,279 | 🐛 2 | 🌐 Java | 📅 2025-12-16 - Provides simple APIs to access any Amazon S3-compatible object storage server.
* [cactoos](https://github.com/yegor256/cactoos) ⭐ 767 | 🐛 83 | 🌐 Java | 📅 2026-02-12 - Collection of object-oriented primitives.
* [Underscore-java](https://github.com/javadev/underscore-java) ⭐ 548 | 🐛 0 | 🌐 Java | 📅 2026-02-05 - Port of Underscore.js functions.
* [Semver4j](https://github.com/semver4j/semver4j) ⭐ 108 | 🐛 0 | 🌐 Java | 📅 2026-02-07 - Lightweight library that helps you handling semantic versioning with different modes.
...
* [dregex](https://github.com/marianobarrios/dregex) ⭐ 49 | 🐛 2 | 🌐 Java | 📅 2026-02-14 - Regular expression engine that uses deterministic finite automata. It supports some Perl-style features and yet retains linear matching time, and also offers set operations.
...
* [SDKMan](https://github.com/sdkman/sdkman-cli) ⭐ 6,659 | 🐛 189 | 🌐 Gherkin | 📅 2026-01-07 - Java Version Manager inspired by RVM and rbenv. Supports UNIX-based platforms and Windows.
* [jenv](https://github.com/jenv/jenv) ⭐ 6,530 | 🐛 77 | 🌐 Shell | 📅 2025-12-24 - Java Version Manager inspired by rbenv. Can configure globally or per project. Tested on Debian and macOS.
* [jabba](https://github.com/shyiko/jabba) ⭐ 3,369 | 🐛 150 | 🌐 Go | 📅 2024-03-14 - Java Version Manager inspired by nvm. Supports macOS, Linux and Windows.

### Web Crawling

*Libraries that analyze the content of websites.*

* [webmagic](https://github.com/code4craft/webmagic) ⭐ 11,697 | 🐛 367 | 🌐 Java | 📅 2025-12-20 - Scalable crawler with downloading, url management, content extraction and persistent.
* [Crawler4j](https://github.com/yasserg/crawler4j) ⭐ 4,628 | 🐛 187 | 🌐 Java | 📅 2021-11-04 - Simple and lightweight web crawler.
...
* [Blade](https://github.com/lets-blade/blade) ⭐ 5,885 | 🐛 14 | 🌐 Java | 📅 2025-12-15 - Lightweight, modular framework that aims to be elegant and simple.
* [Erupt](https://github.com/erupts/erupt) ⭐ 2,686 | 🐛 7 | 🌐 Java | 📅 2026-02-14 - Annotation-Driven Low-Code & JPA Visualization
* [Takes](https://github.com/yegor256/takes) ⭐ 871 | 🐛 106 | 🌐 Java | 📅 2026-02-14 - Opinionated web framework which is built around the concepts of True Object-Oriented Programming and immutability.
...
* [flowable](https://github.com/flowable/flowable-engine) ⭐ 9,085 | 🐛 386 | 🌐 Java | 📅 2026-02-13 - Compact and efficient workflow and business process management platform.
...
* [Awesome Microservices](https://github.com/mfornos/awesome-microservices) ⭐ 14,137 | 🐛 7 | 📅 2026-01-17
* [Useful Java Links](https://github.com/Vedenin/useful-java-links) ⭐ 6,144 | 🐛 17 | 🌐 Java | 📅 2025-07-12
* [Java Developer Roadmap](https://github.com/s4kibs4mi/java-developer-roadmap) ⭐ 4,416 | 🐛 0 | 🌐 Java | 📅 2026-01-26
* [Awesome REST](https://github.com/marmelab/awesome-rest) ⭐ 3,842 | 🐛 13 | 📅 2026-01-03
* [AwesomeJavaFX](https://github.com/mhrimaz/AwesomeJavaFX) ⭐ 3,353 | 🐛 12 | 📅 2025-07-05
* [Awesome JVM](https://github.com/deephacks/awesome-jvm) ⭐ 2,157 | 🐛 15 | 📅 2022-08-30
* [ciandcd](https://github.com/ciandcd/awesome-ciandcd) ⭐ 1,982 | 🐛 18 | 📅 2024-04-01
* [Java Concurrency Checklist](https://github.com/code-review-checklists/java-concurrency) ⭐ 1,353 | 🐛 10 | 📅 2020-11-07
* [Awesome Selenium](https://github.com/christian-bromann/awesome-selenium) ⭐ 1,111 | 🐛 0 | 📅 2025-01-03
...
* [Awesome Graal](https://github.com/neomatrix369/awesome-graal) ⭐ 369 | 🐛 3 | 🌐 Shell | 📅 2023-02-15
* [Awesome J2ME](https://github.com/hstsethi/awesome-j2me) ⭐ 313 | 🐛 1 | 🌐 Java | 📅 2026-02-14
...
Please have a look at the [CONTRIBUTING](https://github.com/akullpp/awesome-java/blob/master/CONTRIBUTING.md) ⭐ 47,037 | 🐛 3 | 📅 2026-02-07 guidelines and [the validation tools](https://github.com/akullpp/awesome-java-lint) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2020-07-19.
