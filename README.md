...
[Please find a different kind of layout here](https://github.com/akullpp/awesome-java/tree/test) ⭐ 46,961 | 🐛 3 | 📅 2026-02-07.

We are evaluating to make this the default, you can provide feedback here in [#1171](https://github.com/akullpp/awesome-java/issues/1171) ⭐ 46,961 | 🐛 3 | 📅 2026-02-07.
...
* [ArchUnit](https://github.com/TNG/ArchUnit) ⭐ 3,594 | 🐛 180 | 🌐 Java | 📅 2026-01-27 - Test library for specifying and asserting architecture rules.
...
* [LangChain4j](https://github.com/langchain4j/langchain4j) ⭐ 10,678 | 🐛 649 | 🌐 Java | 📅 2026-02-06 - Simplifies integration of LLMs with unified APIs and a comprehensive toolbox.
* [MCP Java SDK](https://github.com/modelcontextprotocol/java-sdk) ⭐ 3,152 | 🐛 312 | 🌐 Java | 📅 2026-02-06 - Enables applications to interact with AI models and tools through a standardized interface (i.e. Model Context Protocol), supporting both synchronous and asynchronous communication patterns.
...
* [MapStruct](https://github.com/mapstruct/mapstruct) ⭐ 7,614 | 🐛 492 | 🌐 Java | 📅 2026-02-02 - Code generator that simplifies mappings between different bean types, based on a convention-over-configuration approach.
...
* [Buck2](https://github.com/facebook/buck2) ⭐ 4,247 | 🐛 343 | 🌐 Rust | 📅 2026-02-09 - Encourages the creation of small, reusable modules consisting of code and resources.
...
* [Mixin](https://github.com/SpongePowered/Mixin) ⭐ 1,665 | 🐛 111 | 🌐 Java | 📅 2024-08-05 - Manipulate bytecode at runtime using real Java code.
...
* [Caffeine](https://github.com/ben-manes/caffeine) ⭐ 17,456 | 🐛 2 | 🌐 Java | 📅 2026-02-05 - High-performance, near-optimal caching library.
...
* [p3c](https://github.com/alibaba/p3c) ⭐ 30,825 | 🐛 186 | 🌐 Kotlin | 📅 2024-08-06 - Provides Alibaba's coding guidelines for PMD, IDEA and Eclipse.
* [Infer](https://github.com/facebook/infer) ⭐ 15,517 | 🐛 407 | 🌐 OCaml | 📅 2026-02-07 - Modern static analysis tool for verifying the correctness of code.
* [Checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 8,850 | 🐛 930 | 🌐 Java | 📅 2026-02-09 - Static analysis of coding conventions and standards. (LGPL-2.1-or-later)
* [Error Prone](https://github.com/google/error-prone) ⭐ 7,134 | 🐛 463 | 🌐 Java | 📅 2026-02-06 - Catches common programming mistakes as compile-time errors.
...
* [Spoon](https://github.com/INRIA/spoon) ⭐ 1,898 | 🐛 358 | 🌐 Java | 📅 2026-02-09 - Library for analyzing and transforming Java source code.
* [SonarJava](https://github.com/SonarSource/sonar-java) ⭐ 1,190 | 🐛 13 | 🌐 Java | 📅 2026-02-08 - Static analyzer for SonarQube & SonarLint. (LGPL-3.0-only)
...
* [Error Prone Support](https://github.com/PicnicSupermarket/error-prone-support) ⭐ 232 | 🐛 51 | 🌐 Java | 📅 2026-02-09 - Error Prone extensions: extra bug checkers and a large battery of Refaster templates.
...
* [JHipster](https://github.com/jhipster/generator-jhipster) ⭐ 22,343 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-09 - Yeoman source code generator for Spring Boot and AngularJS.
* [JavaPoet](https://github.com/square/javapoet) ⚠️ Archived - API to generate source files.
* [Auto](https://github.com/google/auto) ⭐ 10,551 | 🐛 86 | 🌐 Java | 📅 2026-02-03 - Generates factory, service, and value classes.
...
* [centraldogma](https://github.com/line/centraldogma) ⭐ 655 | 🐛 165 | 🌐 Java | 📅 2026-02-06 - Highly-available version-controlled service configuration repository based on Git, ZooKeeper and HTTP/2.
...
* [JaCoP](https://github.com/radsz/jacop) ⭐ 232 | 🐛 9 | 🌐 Java | 📅 2026-02-08 - Includes an interface for the FlatZinc language, enabling it to execute MiniZinc models. (AGPL-3.0)
...
* [Protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,663 | 🐛 226 | 🌐 C++ | 📅 2026-02-09 - Google's data interchange format.
* [Wire](https://github.com/square/wire) ⭐ 4,406 | 🐛 170 | 🌐 Kotlin | 📅 2026-02-08 - Clean, lightweight protocol buffers.
...
* [Redisson](https://github.com/redisson/redisson) ⭐ 24,243 | 🐛 298 | 🌐 Java | 📅 2026-02-09 - Allows for distributed and scalable data structures on top of a Redis server.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 20,994 | 🐛 526 | 🌐 Java | 📅 2025-11-04 - High-performance JDBC connection pool.
* [Apache ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,672 | 🐛 362 | 🌐 Java | 📅 2026-02-09 - Distributed SQL transaction & query engine that allows for data sharding, scaling, encryption, and more on any database.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 16,658 | 🐛 795 | 🌐 Java | 📅 2026-02-09 - High-performance SQL database for time series. Supports InfluxDB line protocol, PostgreSQL wire protocol, and REST.
...
* [Leaf](https://github.com/Meituan-Dianping/Leaf) ⭐ 6,728 | 🐛 95 | 🌐 Java | 📅 2023-07-18 - Distributed ID generate service.
...
* [Jinq](https://github.com/my2iu/Jinq) ⭐ 662 | 🐛 36 | 🌐 Java | 📅 2025-06-08 - Typesafe database queries via symbolic execution of Java 8 Lambdas (on top of JPA or jOOQ).
* [CosId](https://github.com/Ahoo-Wang/CosId) ⭐ 606 | 🐛 13 | 🌐 Java | 📅 2026-02-08 - Universal, flexible, high-performance distributed ID generator.
* [eXist](https://github.com/eXist-db/exist) ⭐ 460 | 🐛 603 | 🌐 Java | 📅 2026-02-09 - NoSQL document database and application platform. (LGPL-2.1-only)
...
* [java-tron](https://github.com/tronprotocol/java-tron) ⭐ 4,026 | 🐛 35 | 🌐 Java | 📅 2026-02-04 Implementation of the Tron Protocol, whic utilizes blockchains to develop decentralized applications.
...
* [JavaParser](https://github.com/javaparser/javaparser) ⭐ 6,043 | 🐛 448 | 🌐 Java | 📅 2026-02-09 - Parse, modify and generate Java code.
* [Manifold](https://github.com/manifold-systems/manifold) ⭐ 2,703 | 🐛 109 | 🌐 Java | 📅 2026-02-03 - Re-energizes Java with powerful features like type-safe metaprogramming, structural typing and extension methods.
* [HotswapAgent](https://github.com/HotswapProjects/HotswapAgent) ⭐ 2,566 | 🐛 105 | 🌐 Java | 📅 2026-02-08 - Unlimited runtime class and resource redefinition. (GPL-2.0-only)
...
* [Seata](https://github.com/seata/seata) ⭐ 25,945 | 🐛 869 | 🌐 Java | 📅 2026-02-07 - Delivers high performance and easy to use distributed transaction services under a microservices architecture.
...
* [Artipie](https://github.com/artipie/artipie) ⭐ 655 | 🐛 86 | 🌐 Java | 📅 2025-09-17 - Binary artifact management toolkit which hosts them on the file system or S3.
* [Getdown](https://github.com/threerings/getdown) ⭐ 531 | 🐛 49 | 🌐 Java | 📅 2025-01-07 - System for deploying Java applications to end-user computers and keeping them up to date. Developed as an alternative to Java Web Start.
...
* [Sierra](https://github.com/HTTP-RPC/Sierra) ⭐ 137 | 🐛 0 | 🌐 Java | 📅 2026-02-08 - Lightwieght declarative DSL for rapid development of Swing applications.
...
* [JCTools](https://github.com/JCTools/JCTools) ⭐ 3,799 | 🐛 54 | 🌐 Java | 📅 2026-02-08 - Concurrency tools currently missing from the JDK.
...
* [Feign](https://github.com/OpenFeign/feign) ⭐ 9,790 | 🐛 239 | 🌐 Java | 📅 2026-02-07 - HTTP client binder inspired by Retrofit, JAXRS-2.0, and WebSocket.
* [Async Http Client](https://github.com/AsyncHttpClient/async-http-client) ⭐ 6,405 | 🐛 106 | 🌐 Java | 📅 2026-02-08 - Asynchronous HTTP and WebSocket client library.
...
* [Google HTTP Client](https://github.com/googleapis/google-http-java-client) ⭐ 1,433 | 🐛 75 | 🌐 Java | 📅 2026-02-06 - Pluggable HTTP transport abstraction with support for java.net.HttpURLConnection, Apache HTTP Client, Android, Google App Engine, XML, Gson, Jackson and Protobuf.
* [Riptide](https://github.com/zalando/riptide) ⭐ 331 | 🐛 22 | 🌐 Java | 📅 2026-02-09 - Client-side response routing for Spring's RestTemplate.
...
* [ZXing](https://github.com/zxing/zxing) ⭐ 33,842 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - Multi-format 1D/2D barcode image processing library.
...
* [JobRunr](https://github.com/jobrunr/jobrunr) ⭐ 2,857 | 🐛 5 | 🌐 Java | 📅 2026-02-06 - Job scheduling library which utilizes lambdas for fire-and-forget, delayed and recurring jobs. Guarantees execution by single scheduler instance using optimistic locking. Has features for persistence, minimal dependencies and is embeddable.
* [db-scheduler](https://github.com/kagkarlsson/db-scheduler) ⭐ 1,497 | 🐛 94 | 🌐 Java | 📅 2026-02-04 - Persistent and cluster-friendly scheduler.
...
* [JSON-io](https://github.com/jdereg/json-io) ⭐ 369 | 🐛 2 | 🌐 Java | 📅 2026-02-09 - Convert Java to JSON/TOON and back. Supports complex object graphs, cyclic references, and TOON format for 40-50% LLM token savings.
...
* [Graal](https://github.com/oracle/graal) ⭐ 21,454 | 🐛 809 | 🌐 Java | 📅 2026-02-08 - Polyglot embeddable JVM. (GPL-2.0-only WITH Classpath-exception-2.0)
* [Dragonwell8](https://github.com/alibaba/dragonwell8) ⭐ 4,318 | 🐛 171 | 🌐 Java | 📅 2026-02-09 - Downstream version of OpenJDK optimized for online e-commerce, financial, logistics applications.
* [OpenJ9](https://github.com/eclipse/openj9) ⭐ 3,503 | 🐛 3,012 | 🌐 Java | 📅 2026-02-07 - High performance, enterprise-calibre, flexibly licensed, openly-governed cross-platform JVM extending and augmenting the runtime technology components from the Eclipse OMR and OpenJDK project.
* [ParparVM](https://github.com/codenameone/CodenameOne/tree/master/vm) ⭐ 1,820 | 🐛 555 | 🌐 Java | 📅 2026-02-08 - VM with non-blocking, concurrent GC for iOS. (GPL-2.0-only WITH Classpath-exception-2.0)
...
* [Smile](https://github.com/haifengl/smile) ⭐ 6,336 | 🐛 6 | 🌐 Java | 📅 2026-02-09 - Statistical Machine Intelligence and Learning Engine provides a set of machine learning algorithms and a visualization library.
...
* [AutoMQ](https://github.com/AutoMQ/automq-for-kafka) ⭐ 9,473 | 🐛 82 | 🌐 Java | 📅 2026-02-09 - AutoMQ is a cloud-native, serverless reinvented Kafka that is easily scalable, manage-less and cost-effective.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,437 | 🐛 17 | 🌐 Java | 📅 2026-02-07 - Efficient, reliable, unicast and multicast message transport.
...
* [RabbitMQ Java client](https://github.com/rabbitmq/rabbitmq-java-client) ⭐ 1,297 | 🐛 25 | 🌐 Java | 📅 2026-02-09 - RabbitMQ client.
...
* [Design Patterns](https://github.com/iluwatar/java-design-patterns) ⭐ 93,700 | 🐛 210 | 🌐 Java | 📅 2026-02-08 - Implementation and explanation of the most common design patterns.
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,234 | 🐛 538 | 🌐 Java | 📅 2024-07-15 - No-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes. (No explicit license)
* [Modern Java - A Guide to Java 8](https://github.com/winterbe/java8-tutorial) ⭐ 16,780 | 🐛 19 | 🌐 Java | 📅 2023-08-11 - Popular Java 8 guide.
...
* [Svix](https://github.com/svix/svix-webhooks/tree/main/java) ⭐ 3,098 | 🐛 58 | 🌐 Rust | 📅 2026-02-06 - Library for the Svix API to send webhooks and verify signatures.
* [Jimfs](https://github.com/google/jimfs) ⭐ 2,529 | 🐛 37 | 🌐 Java | 📅 2026-02-02 - In-memory file system.
...
* [TypeTools](https://github.com/jhalterman/typetools) ⭐ 629 | 🐛 24 | 🌐 Java | 📅 2023-04-12 - Tools for resolving generic types.
* [Membrane Service Proxy](https://github.com/membrane/service-proxy) ⭐ 557 | 🐛 29 | 🌐 Java | 📅 2026-02-08 - Open-source, reverse-proxy framework.
...
* [Pinpoint](https://github.com/naver/pinpoint) ⭐ 13,805 | 🐛 511 | 🌐 Java | 📅 2026-02-09 - Open-source APM tool.
* [Dropwizard Metrics](https://github.com/dropwizard/metrics) ⭐ 7,855 | 🐛 19 | 🌐 Java | 📅 2026-02-09 - Expose metrics via JMX or HTTP and send them to a database.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,067 | 🐛 310 | 🌐 Java | 📅 2026-02-09 - Real-time monitoring system with custom-monitor and agentless.
...
* [Micrometer](https://github.com/micrometer-metrics/micrometer) ⭐ 4,801 | 🐛 287 | 🌐 Java | 📅 2026-02-09 - Vendor-neutral metrics/observability facade for the most popular metrics/observability libraries.
* [JavaMelody](https://github.com/javamelody/javamelody) ⭐ 3,034 | 🐛 46 | 🌐 Java | 📅 2026-02-02 - Performance monitoring and profiling.
* [OpenTelemetry](https://github.com/open-telemetry/opentelemetry-java) ⭐ 2,353 | 🐛 173 | 🌐 Java | 📅 2026-02-09 - Instrument, generate, collect, and export telemetry data to help you analyze your software’s performance and behavior.
* [Prometheus](https://github.com/prometheus/client_java) ⭐ 2,264 | 🐛 129 | 🌐 Java | 📅 2026-02-09 - Provides a multi-dimensional data model, DSL, autonomous server nodes and much more.
...
* [Sentry ![c]](https://github.com/getsentry/sentry-java) ⭐ 1,297 | 🐛 229 | 🌐 Kotlin | 📅 2026-02-09 - Integration with [Sentry](https://github.com/getsentry/sentry) ⭐ 43,121 | 🐛 2,044 | 🌐 Python | 📅 2026-02-08, an application error tracking and performance analysis platform.
* [Datadog ![c]](https://github.com/DataDog/dd-trace-java) ⭐ 690 | 🐛 309 | 🌐 Java | 📅 2026-02-09 - Modern monitoring & analytics.
...
* [JNA](https://github.com/java-native-access/jna) ⭐ 8,887 | 🐛 119 | 🌐 Java | 📅 2026-01-01 - Work with native libraries without writing JNI. Also provides interfaces to common system libraries.
...
* [Dubbo](https://github.com/apache/dubbo) ⭐ 41,722 | 🐛 912 | 🌐 Java | 📅 2026-02-05 - High-performance RPC framework.
* [gRPC-java](https://github.com/grpc/grpc-java) ⭐ 11,971 | 🐛 509 | 🌐 Java | 📅 2026-02-06 - RPC framework based on protobuf and HTTP/2.
...
* [MyBatis](https://github.com/mybatis/mybatis-3) ⭐ 20,376 | 🐛 200 | 🌐 Java | 📅 2026-02-07 - Couples objects with stored procedures or SQL statements.
* [MyBatis-Plus](https://github.com/baomidou/mybatis-plus) ⭐ 17,297 | 🐛 105 | 🌐 Java | 📅 2026-02-07 - A powerful enhanced toolkit of MyBatis for simplifying development.
...
* [OpenPDF](https://github.com/LibrePDF/OpenPDF) ⭐ 4,175 | 🐛 162 | 🌐 Java | 📅 2025-10-27 - Open-source iText fork. (LGPL-3.0-only & MPL-2.0)
* [flyingsaucer](https://github.com/flyingsaucerproject/flyingsaucer) ⭐ 2,195 | 🐛 39 | 🌐 Java | 📅 2026-02-06 - XML/XHTML and CSS 2.1 renderer. (LGPL-2.1-or-later)
* [Tabula](https://github.com/tabulapdf/tabula-java) ⭐ 2,004 | 🐛 194 | 🌐 Java | 📅 2025-03-19 - Extracts tables from PDF files.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,770 | 🐛 5,580 | 🌐 Java | 📅 2026-02-07 - Allows generation of API client libraries, SDKs, server stubs, documentation and configuration automatically given an OpenAPI Spec.
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,593 | 🐛 34 | 🌐 Java | 📅 2026-02-09 - Opinionated framework for setting up modern web applications with Jetty, Jackson, Jersey and Metrics.
...
* [XChart](https://github.com/knowm/XChart) ⭐ 1,576 | 🐛 157 | 🌐 Java | 📅 2025-10-27 - Light-weight library for plotting data. Many customizable chart types are available.
...
* [jjwt](https://github.com/jwtk/jjwt) ⭐ 11,016 | 🐛 48 | 🌐 Java | 📅 2025-10-17 - JSON web token for Java and Android.
...
* [Ayza](https://github.com/Hakky54/ayza) ⭐ 570 | 🐛 1 | 🌐 Java | 📅 2026-02-09 - High-level SSL configuration builder for configuring HTTP clients and servers with SSL/TLS.
...
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 25,529 | 🐛 144 | 🌐 C++ | 📅 2026-02-07 - Memory-efficient serialization library that can access serialized data without unpacking and parsing it.
...
* [jte](https://github.com/casid/jte) ⭐ 1,073 | 🐛 53 | 🌐 Java | 📅 2026-02-04 - Compiles to classes, and uses an easy syntax, several features to make development easier and provides fast execution and a small footprint.
...
* [Instancio](https://github.com/instancio/instancio) ⭐ 1,104 | 🐛 9 | 🌐 Java | 📅 2026-02-09 - Automates data setup in unit tests by generating fully-populated, reproducible objects. Includes JUnit 5 extension.
...
* [JsonUnit](https://github.com/lukas-krecan/JsonUnit) ⭐ 980 | 🐛 19 | 🌐 Java | 📅 2026-02-09 - Library that simplifies JSON comparison in tests.
...
* [Testcontainers](https://github.com/testcontainers/testcontainers-java) ⭐ 8,576 | 🐛 626 | 🌐 Java | 📅 2026-02-03 - Provides throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
...
* [EasyMock](https://github.com/easymock/easymock) ⭐ 830 | 🐛 62 | 🌐 HTML | 📅 2026-02-09 - EasyMock is a Java library that provides an easy way to use Mock Objects in unit testing.
...
* [Guava](https://github.com/google/guava) ⭐ 51,462 | 🐛 718 | 🌐 Java | 📅 2026-02-07 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and more.
* [Arthas](https://github.com/alibaba/arthas) ⭐ 37,076 | 🐛 461 | 🌐 Java | 📅 2026-02-03 - Allows to troubleshoot production issues for applications without modifying code or restarting servers.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,356 | 🐛 548 | 🌐 Java | 📅 2026-02-08 - Cross-platform for visualizing and manipulating large graph networks. (GPL-3.0-only)
...
* [cactoos](https://github.com/yegor256/cactoos) ⭐ 766 | 🐛 81 | 🌐 Java | 📅 2026-02-08 - Collection of object-oriented primitives.
...
* [Erupt](https://github.com/erupts/erupt) ⭐ 2,681 | 🐛 6 | 🌐 Java | 📅 2026-02-08 - Annotation-Driven Low-Code & JPA Visualization
* [Takes](https://github.com/yegor256/takes) ⭐ 870 | 🐛 106 | 🌐 Java | 📅 2026-02-08 - Opinionated web framework which is built around the concepts of True Object-Oriented Programming and immutability.
...
* [flowable](https://github.com/flowable/flowable-engine) ⭐ 9,071 | 🐛 385 | 🌐 Java | 📅 2026-02-04 - Compact and efficient workflow and business process management platform.
...
* [Awesome Microservices](https://github.com/mfornos/awesome-microservices) ⭐ 14,129 | 🐛 7 | 📅 2026-01-17
...
* [AwesomeJavaFX](https://github.com/mhrimaz/AwesomeJavaFX) ⭐ 3,350 | 🐛 12 | 📅 2025-07-05
* [Awesome JVM](https://github.com/deephacks/awesome-jvm) ⭐ 2,155 | 🐛 15 | 📅 2022-08-30
...
Please have a look at the [CONTRIBUTING](https://github.com/akullpp/awesome-java/blob/master/CONTRIBUTING.md) ⭐ 46,961 | 🐛 3 | 📅 2026-02-07 guidelines and [the validation tools](https://github.com/akullpp/awesome-java-lint) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2020-07-19.
